...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2010_CORE;                                                         
INFILE 'SC_SID_2010_CORE.ASC' FIRSTOBS=3 LRECL = 645;                           
...
INPUT                                                                           
      ...
      @385    PAY1                          N2PF.                               
      @387    PAY1_X                        $CHAR2.                             
      @389    PL_NCHS2006                   N2PF.                               
      @391    PL_RUCA10_2005                N2PF.                               
      @393    PL_RUCA4_2005                 N2PF.                               
      @395    PL_UR_CAT4                    N2PF.                               
      @397    PR1                           $CHAR7.                             
      @404    PR2                           $CHAR7.                             
      @411    PR3                           $CHAR7.                             
