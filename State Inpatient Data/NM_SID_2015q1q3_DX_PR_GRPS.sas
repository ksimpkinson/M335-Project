...
*   NM_SID_2015q1q3_DX_PR_GRPS.SAS:                                             
...
*  Data Step                  *;                                                
*******************************;                                                
DATA NM_SIDC_2015q1q3_DX_PR_GRPS;                                               
INFILE 'NM_SID_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 536;                 
...
INPUT                                                                           
      ...
      @370    INJURY                        N2PF.                               
      @372    INJURY_CUT                    N2PF.                               
      @374    INJURY_DROWN                  N2PF.                               
      @376    INJURY_FALL                   N2PF.                               
      @378    INJURY_FIRE                   N2PF.                               
      @380    INJURY_FIREARM                N2PF.                               
      @382    INJURY_MACHINERY              N2PF.                               
      @384    INJURY_MVT                    N2PF.                               
      @386    INJURY_NATURE                 N2PF.                               
      @388    INJURY_POISON                 N2PF.                               
      @390    INJURY_STRUCK                 N2PF.                               
      @392    INJURY_SUFFOCATION            N2PF.                               
      @394    INTENT_ASSAULT                N2PF.                               
      @396    INTENT_SELF_HARM              N2PF.                               
      @398    INTENT_UNINTENTIONAL          N2PF.                               
      @400    KEY                           15.                                 
      @415    MULTINJURY                    N2PF.                               
      @417    PCLASS1                       N2PF.                               
      @419    PCLASS2                       N2PF.                               
      ...
      @511    U_NEWBN4L                     N2PF.                               
      @513    U_NUCMED                      N2PF.                               
      @515    U_OBSERVATION                 N2PF.                               
      @517    U_OCCTHERAPY                  N2PF.                               
      @519    U_ORGANACQ                    N2PF.                               
      @521    U_OTHIMPLANTS                 N2PF.                               
      @523    U_PACEMAKER                   N2PF.                               
      @525    U_PHYTHERAPY                  N2PF.                               
      @527    U_RADTHERAPY                  N2PF.                               
      @529    U_RESPTHERAPY                 N2PF.                               
      @531    U_SPEECHTHERAPY               N2PF.                               
      @533    U_STRESS                      N2PF.                               
      @535    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
