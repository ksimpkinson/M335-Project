...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SIDC_2014_DX_PR_GRPS;                                                   
INFILE 'AR_SID_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 589;                     
...
INPUT                                                                           
      ...
      @403    INJURY                        N2PF.                               
      @405    INJURY_CUT                    N2PF.                               
      @407    INJURY_DROWN                  N2PF.                               
      @409    INJURY_FALL                   N2PF.                               
      @411    INJURY_FIRE                   N2PF.                               
      @413    INJURY_FIREARM                N2PF.                               
      @415    INJURY_MACHINERY              N2PF.                               
      @417    INJURY_MVT                    N2PF.                               
      @419    INJURY_NATURE                 N2PF.                               
      @421    INJURY_POISON                 N2PF.                               
      @423    INJURY_STRUCK                 N2PF.                               
      @425    INJURY_SUFFOCATION            N2PF.                               
      @427    INTENT_ASSAULT                N2PF.                               
      @429    INTENT_SELF_HARM              N2PF.                               
      @431    INTENT_UNINTENTIONAL          N2PF.                               
      @433    KEY                           15.                                 
      @448    MULTINJURY                    N2PF.                               
      @450    PCLASS1                       N2PF.                               
      @452    PCLASS2                       N2PF.                               
      ...
      @564    U_NEWBN4L                     N2PF.                               
      @566    U_NUCMED                      N2PF.                               
      @568    U_OBSERVATION                 N2PF.                               
      @570    U_OCCTHERAPY                  N2PF.                               
      @572    U_ORGANACQ                    N2PF.                               
      @574    U_OTHIMPLANTS                 N2PF.                               
      @576    U_PACEMAKER                   N2PF.                               
      @578    U_PHYTHERAPY                  N2PF.                               
      @580    U_RADTHERAPY                  N2PF.                               
      @582    U_RESPTHERAPY                 N2PF.                               
      @584    U_SPEECHTHERAPY               N2PF.                               
      @586    U_STRESS                      N2PF.                               
      @588    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
