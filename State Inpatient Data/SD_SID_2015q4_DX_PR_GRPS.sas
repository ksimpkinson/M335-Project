...
*  Data Step                  *;                                                
*******************************;                                                
DATA SD_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'SD_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 759;                   
...
INPUT                                                                           
      ...
      @431    I10_INJURY                    N2PF.                               
      @433    I10_MULTINJURY                N2PF.                               
      @435    I10_PCLASS1                   N2PF.                               
      @437    I10_PCLASS2                   N2PF.                               
      @439    I10_PCLASS3                   N2PF.                               
      @441    I10_PCLASS4                   N2PF.                               
      @443    I10_PCLASS5                   N2PF.                               
      @445    I10_PCLASS6                   N2PF.                               
      @447    I10_PCLASS7                   N2PF.                               
      @449    I10_PCLASS8                   N2PF.                               
      @451    I10_PCLASS9                   N2PF.                               
      @453    I10_PCLASS10                  N2PF.                               
      @455    I10_PCLASS11                  N2PF.                               
      @457    I10_PCLASS12                  N2PF.                               
      @459    I10_PCLASS13                  N2PF.                               
      @461    I10_PCLASS14                  N2PF.                               
      @463    I10_PCLASS15                  N2PF.                               
      @465    I10_PCLASS16                  N2PF.                               
      @467    I10_PCLASS17                  N2PF.                               
      @469    I10_PCLASS18                  N2PF.                               
      @471    I10_PCLASS19                  N2PF.                               
      @473    I10_PCLASS20                  N2PF.                               
      @475    I10_PCLASS21                  N2PF.                               
      @477    I10_PCLASS22                  N2PF.                               
      @479    I10_PCLASS23                  N2PF.                               
      @481    I10_PCLASS24                  N2PF.                               
      @483    I10_PCLASS25                  N2PF.                               
      @485    I10_PRMCCS1                   $CHAR8.                             
      @493    I10_PRMCCS2                   $CHAR8.                             
      @501    I10_PRMCCS3                   $CHAR8.                             
      @509    I10_PRMCCS4                   $CHAR8.                             
      @517    I10_PRMCCS5                   $CHAR8.                             
      @525    I10_PRMCCS6                   $CHAR8.                             
      @533    I10_PRMCCS7                   $CHAR8.                             
      @541    I10_PRMCCS8                   $CHAR8.                             
      @549    I10_PRMCCS9                   $CHAR8.                             
      @557    I10_PRMCCS10                  $CHAR8.                             
      @565    I10_PRMCCS11                  $CHAR8.                             
      @573    I10_PRMCCS12                  $CHAR8.                             
      @581    I10_PRMCCS13                  $CHAR8.                             
      @589    I10_PRMCCS14                  $CHAR8.                             
      @597    I10_PRMCCS15                  $CHAR8.                             
      @605    I10_PRMCCS16                  $CHAR8.                             
      @613    I10_PRMCCS17                  $CHAR8.                             
      @621    I10_PRMCCS18                  $CHAR8.                             
      @629    I10_PRMCCS19                  $CHAR8.                             
      @637    I10_PRMCCS20                  $CHAR8.                             
      @645    I10_PRMCCS21                  $CHAR8.                             
      @653    I10_PRMCCS22                  $CHAR8.                             
      @661    I10_PRMCCS23                  $CHAR8.                             
      @669    I10_PRMCCS24                  $CHAR8.                             
      @677    I10_PRMCCS25                  $CHAR8.                             
      @685    I10_U_BLOOD                   N2PF.                               
      @687    I10_U_CATH                    N2PF.                               
      @689    I10_U_CTSCAN                  N2PF.                               
      @691    I10_U_EKG                     N2PF.                               
      @693    I10_U_MHSA                    N2PF.                               
      @695    I10_U_MRT                     N2PF.                               
      @697    I10_U_PACEMAKER               N2PF.                               
      @699    I10_U_PHYTHERAPY              N2PF.                               
      @701    I10_U_RADTHERAPY              N2PF.                               
      @703    I10_U_STRESS                  N2PF.                               
      @705    KEY                           15.                                 
      @720    U_CCU                         N2PF.                               
      @722    U_CHESTXRAY                   N2PF.                               
      @724    U_DIALYSIS                    N2PF.                               
      @726    U_ECHO                        N2PF.                               
      @728    U_ED                          N2PF.                               
      @730    U_EEG                         N2PF.                               
      @732    U_EPO                         N2PF.                               
      @734    U_ICU                         N2PF.                               
      @736    U_LITHOTRIPSY                 N2PF.                               
      @738    U_NEWBN2L                     N2PF.                               
      @740    U_NEWBN3L                     N2PF.                               
      @742    U_NEWBN4L                     N2PF.                               
      @744    U_NUCMED                      N2PF.                               
      @746    U_OBSERVATION                 N2PF.                               
      @748    U_OCCTHERAPY                  N2PF.                               
      @750    U_ORGANACQ                    N2PF.                               
      @752    U_OTHIMPLANTS                 N2PF.                               
      @754    U_RESPTHERAPY                 N2PF.                               
      @756    U_SPEECHTHERAPY               N2PF.                               
      @758    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
