...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SIDC_2013_DX_PR_GRPS;                                                   
INFILE 'KS_SID_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 879;                     
...
INPUT                                                                           
      ...
      @583    INJURY                        N2PF.                               
      @585    INJURY_CUT                    N2PF.                               
      @587    INJURY_DROWN                  N2PF.                               
      @589    INJURY_FALL                   N2PF.                               
      @591    INJURY_FIRE                   N2PF.                               
      @593    INJURY_FIREARM                N2PF.                               
      @595    INJURY_MACHINERY              N2PF.                               
      @597    INJURY_MVT                    N2PF.                               
      @599    INJURY_NATURE                 N2PF.                               
      @601    INJURY_POISON                 N2PF.                               
      @603    INJURY_STRUCK                 N2PF.                               
      @605    INJURY_SUFFOCATION            N2PF.                               
      @607    INTENT_ASSAULT                N2PF.                               
      @609    INTENT_SELF_HARM              N2PF.                               
      @611    INTENT_UNINTENTIONAL          N2PF.                               
      @613    KEY                           15.                                 
      @628    MULTINJURY                    N2PF.                               
      @630    PCLASS1                       N2PF.                               
      @632    PCLASS2                       N2PF.                               
