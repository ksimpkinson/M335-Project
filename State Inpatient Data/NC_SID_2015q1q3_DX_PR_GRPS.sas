...
*   NC_SID_2015q1q3_DX_PR_GRPS.SAS:                                             
...
*  Data Step                  *;                                                
*******************************;                                                
DATA NC_SIDC_2015q1q3_DX_PR_GRPS;                                               
INFILE 'NC_SID_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 759;                 
...
INPUT                                                                           
      ...
      @453    INJURY                        N2PF.                               
      @455    INJURY_CUT                    N2PF.                               
      @457    INJURY_DROWN                  N2PF.                               
      @459    INJURY_FALL                   N2PF.                               
      @461    INJURY_FIRE                   N2PF.                               
      @463    INJURY_FIREARM                N2PF.                               
      @465    INJURY_MACHINERY              N2PF.                               
      @467    INJURY_MVT                    N2PF.                               
      @469    INJURY_NATURE                 N2PF.                               
      @471    INJURY_POISON                 N2PF.                               
      @473    INJURY_STRUCK                 N2PF.                               
      @475    INJURY_SUFFOCATION            N2PF.                               
      @477    INTENT_ASSAULT                N2PF.                               
      @479    INTENT_SELF_HARM              N2PF.                               
      @481    INTENT_UNINTENTIONAL          N2PF.                               
      @483    KEY                           15.                                 
      @498    MULTINJURY                    N2PF.                               
      @500    PCLASS1                       N2PF.                               
      @502    PCLASS2                       N2PF.                               
      ...
      @734    U_NEWBN4L                     N2PF.                               
      @736    U_NUCMED                      N2PF.                               
      @738    U_OBSERVATION                 N2PF.                               
      @740    U_OCCTHERAPY                  N2PF.                               
      @742    U_ORGANACQ                    N2PF.                               
      @744    U_OTHIMPLANTS                 N2PF.                               
      @746    U_PACEMAKER                   N2PF.                               
      @748    U_PHYTHERAPY                  N2PF.                               
      @750    U_RADTHERAPY                  N2PF.                               
      @752    U_RESPTHERAPY                 N2PF.                               
      @754    U_SPEECHTHERAPY               N2PF.                               
      @756    U_STRESS                      N2PF.                               
