...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SIDC_2012_CORE;                                                         
INFILE 'AR_SID_2012_CORE.ASC' FIRSTOBS=3 LRECL = 802;                           
...
INPUT                                                                           
      ...
      @284    DXPOA17                       $CHAR1.                             
      @285    DXPOA18                       $CHAR1.                             
      @286    DX_Admitting                  $CHAR7.                             
      @293    DaysToEvent                   N6PF.                               
      @299    ECODE1                        $CHAR7.                             
      @306    ECODE2                        $CHAR7.                             
      @313    ECODE3                        $CHAR7.                             
      @320    ECODE4                        $CHAR7.                             
      ...
      @409    HCUP_ED                       N2PF.                               
      @411    HCUP_OS                       N2PF.                               
      @413    HISPANIC_X                    $CHAR1.                             
      @414    HOSPBRTH                      N3PF.                               
      @417    HOSPST                        $CHAR2.                             
      @419    KEY                           15.                                 
      @434    LOS                           N5PF.                               
      @439    LOS_X                         N6PF.                               
      @445    MARITALSTATUSUB04             $CHAR1.                             
      @446    MARITALSTATUS_X               $CHAR1.                             
      @447    MDC                           N2PF.                               
      @449    MDC24                         N2PF.                               
      @451    MDC_NoPOA                     N2PF.                               
      @453    MDNUM1_R                      N9PF.                               
      ...
      @690    PSTATE                        $CHAR2.                             
      @692    PSTCO2                        N5PF.                               
      @697    PointOfOriginUB04             $CHAR1.                             
      @698    PointOfOrigin_X               $CHAR1.                             
      @699    RACE                          N2PF.                               
      @701    RACE_X                        $CHAR1.                             
      @702    TOTCHG                        N10PF.                              
      @712    TOTCHG_X                      N15P2F.                             
