...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SIDC_2010_DX_PR_GRPS;                                                   
INFILE 'NY_SID_2010_DX_PR_GRPS.ASC' LRECL = 530;                                
...
INPUT                                                                           
      ...
      @517    U_PACEMAKER              N2PF.                                    
      @519    U_PHYTHERAPY             N2PF.                                    
      @521    U_RADTHERAPY             N2PF.                                    
      @523    U_RESPTHERAPY            N2PF.                                    
      @525    U_SPEECHTHERAPY          N2PF.                                    
      @527    U_STRESS                 N2PF.                                    
      @529    U_ULTRASOUND             N2PF.                                    
      ;                                                                         
