...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SIDC_2005_CORE;                                                         
INFILE 'NV_SID_2005_CORE.ASC' LRECL = 462;                                      
...
INPUT                                                                           
      ...
      @258    HCUP_OS                  N2PF.                                    
      @260    HOSPST                   $CHAR2.                                  
      @262    INTENSIVECARE            N2PF.                                    
      @264    LOS                      N5PF.                                    
      @269    LOS_X                    N6PF.                                    
      @275    MEDINCSTQ                N2PF.                                    
      @277    MARITALSTATUS            $CHAR1.                                  
      @278    MDC                      N2PF.                                    
      @280    MDC18                    N2PF.                                    
      @282    MDNUM1_R                 N9PF.                                    
      @291    MDNUM2_R                 N9PF.                                    
      ...
      @314    PAY2_X                   $CHAR2.                                  
      @316    PAY3_X                   $CHAR2.                                  
      @318    PL_NHCS2006              N2PF.                                    
      @320    PL_RUCA10_2005           N2PF.                                    
      @322    PL_RUCA2005              N4P1F.                                   
      @326    PL_RUCA4_2005            N2PF.                                    
      @328    PL_RUCC2003              N2PF.                                    
      @330    PL_UIC2003               N2PF.                                    
      @332    PL_UR_CAT4               N2PF.                                    
      @334    PL_UR_CAT5               N2PF.                                    
      @336    PNUM_R                   N9PF.                                    
