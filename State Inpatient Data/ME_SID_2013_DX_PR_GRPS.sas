...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SIDC_2013_DX_PR_GRPS;                                                   
INFILE 'ME_SID_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 368;                     
...
INPUT                                                                           
      ...
      @202    INJURY                        N2PF.                               
      @204    INJURY_CUT                    N2PF.                               
      @206    INJURY_DROWN                  N2PF.                               
      @208    INJURY_FALL                   N2PF.                               
      @210    INJURY_FIRE                   N2PF.                               
      @212    INJURY_FIREARM                N2PF.                               
      @214    INJURY_MACHINERY              N2PF.                               
      @216    INJURY_MVT                    N2PF.                               
      @218    INJURY_NATURE                 N2PF.                               
      @220    INJURY_POISON                 N2PF.                               
      @222    INJURY_STRUCK                 N2PF.                               
      @224    INJURY_SUFFOCATION            N2PF.                               
      @226    INTENT_ASSAULT                N2PF.                               
      @228    INTENT_SELF_HARM              N2PF.                               
      @230    INTENT_UNINTENTIONAL          N2PF.                               
      @232    KEY                           15.                                 
      @247    MULTINJURY                    N2PF.                               
      @249    PCLASS1                       N2PF.                               
      @251    PCLASS2                       N2PF.                               
      ...
      @343    U_NEWBN4L                     N2PF.                               
      @345    U_NUCMED                      N2PF.                               
      @347    U_OBSERVATION                 N2PF.                               
      @349    U_OCCTHERAPY                  N2PF.                               
      @351    U_ORGANACQ                    N2PF.                               
      @353    U_OTHIMPLANTS                 N2PF.                               
      @355    U_PACEMAKER                   N2PF.                               
      @357    U_PHYTHERAPY                  N2PF.                               
      @359    U_RADTHERAPY                  N2PF.                               
      @361    U_RESPTHERAPY                 N2PF.                               
      @363    U_SPEECHTHERAPY               N2PF.                               
      @365    U_STRESS                      N2PF.                               
      @367    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
