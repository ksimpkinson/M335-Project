...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SIDC_2005_CORE;                                                         
INFILE 'MD_SID_2005_CORE.ASC' LRECL = 578;                                      
...
INPUT                                                                           
      ...
      @274    HCUP_ED                  N2PF.                                    
      @276    HCUP_OS                  N2PF.                                    
      @278    HISPANIC_X               $CHAR1.                                  
      @279    HospitalUnit             N2PF.                                    
      @281    HOSPST                   $CHAR2.                                  
      @283    LOS                      N5PF.                                    
      @288    LOS_X                    N6PF.                                    
      @294    MEDINCSTQ                N2PF.                                    
      @296    MARITALSTATUS            $CHAR1.                                  
      @297    MDC                      N2PF.                                    
      @299    MDC18                    N2PF.                                    
      @301    MDNUM1_R                 N9PF.                                    
      @310    MDNUM2_R                 N9PF.                                    
