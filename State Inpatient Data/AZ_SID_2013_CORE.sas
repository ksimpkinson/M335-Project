...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SIDC_2013_CORE;                                                         
INFILE 'AZ_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 802;                           
...
INPUT                                                                           
      ...
      @500    PL_CBSA                  N3PF.                                    
      @503    PL_NCHS                  N2PF.                                    
      @505    PL_RUCA10_2005           N2PF.                                    
      @507    PL_RUCA2005              N4P1F.                                   
      @511    PL_RUCA4_2005            N2PF.                                    
      @513    PL_RUCC                  N2PF.                                    
      @515    PL_UIC                   N2PF.                                    
      @517    PL_UR_CAT4               N2PF.                                    
      @519    PR1                      $CHAR4.                                  
      ...
      @666    PSTATE                   $CHAR2.                                  
      @668    PSTCO2                   N5PF.                                    
      @673    PointOfOriginUB04        $CHAR1.                                  
      @674    PointOfOrigin_X          $CHAR1.                                  
      @675    RACE                     N2PF.                                    
      @677    RACE_X                   $CHAR4.                                  
      @681    SPLIT_IPED               N2PF.                                    
      @683    TOTCHG                   N10PF.                                   
