...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SIDC_2014_CORE;                                                         
INFILE 'OR_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1208;                          
...
INPUT                                                                           
      ...
      @586    PL_UIC                        N2PF.                               
      @588    PL_UR_CAT4                    N2PF.                               
      @590    POA_Disch_Edit1               N2PF.                               
      @592    POA_Disch_Edit2               N2PF.                               
      @594    POA_Hosp_Edit1                N2PF.                               
      @596    POA_Hosp_Edit2                N2PF.                               
      @598    POA_Hosp_Edit3                N2PF.                               
      @600    POA_Hosp_Edit3_Value          N8P2F.                              
      @608    PR1                           $CHAR7.                             
      @615    PR2                           $CHAR7.                             
      @622    PR3                           $CHAR7.                             
      @629    PR4                           $CHAR7.                             
      ...
      @989    PSTATE                        $CHAR2.                             
      @991    PSTCO2                        N5PF.                               
      @996    PointOfOriginUB04             $CHAR1.                             
      @997    PointOfOrigin_X               $CHAR2.                             
      @999    RACE                          N2PF.                               
      @1001   RACE_X                        $CHAR2.                             
      @1003   SERVICELINE                   N2PF.                               
      @1005   TOTCHG                        N10PF.                              
