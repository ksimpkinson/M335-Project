...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SIDC_2011_CORE;                                                         
INFILE 'KS_SID_2011_CORE.ASC' FIRSTOBS=3 LRECL = 1217;                          
...
INPUT                                                                           
      ...
      @515    HCUP_ED                       N2PF.                               
      @517    HCUP_OS                       N2PF.                               
      @519    HCUP_SURGERY_BROAD            N2PF.                               
      @521    HCUP_SURGERY_NARROW           N2PF.                               
      @523    HISPANIC_X                    $CHAR1.                             
      @524    HOSPBRTH                      N3PF.                               
      @527    HOSPST                        $CHAR2.                             
      @529    HospitalUnit                  N2PF.                               
      @531    KEY                           15.                                 
      @546    LOS                           N5PF.                               
      @551    LOS_X                         N6PF.                               
      @557    MDC                           N2PF.                               
      ...
      @595    PL_CBSA                       N3PF.                               
      @598    PL_MSA1993                    N3PF.                               
      @601    PL_NCHS2006                   N2PF.                               
      @603    PL_RUCA10_2005                N2PF.                               
      @605    PL_RUCA2005                   N4P1F.                              
      @609    PL_RUCA4_2005                 N2PF.                               
      ...
      @997    PSTCO                         N5PF.                               
      @1002   PSTCO2                        N5PF.                               
      @1007   PointOfOriginUB04             $CHAR1.                             
      @1008   PointOfOrigin_X               $CHAR1.                             
      @1009   RACE                          N2PF.                               
      @1011   RACE_X                        $CHAR1.                             
      @1012   TOTCHG                        N10PF.                              
      @1022   TOTCHG_X                      N15P2F.                             
      @1037   TRAN_IN                       N2PF.                               
      @1039   TRAN_OUT                      N2PF.                               
      @1041   YEAR                          N4PF.                               
      @1045   ZIP3                          $CHAR3.                             
      @1048   ZIPINC_QRTL                   N3PF.                               
      @1051   HOSPID                        N5PF.                               
      @1056   AYEAR                         N4PF.                               
      @1060   DMONTH                        N2PF.                               
      @1062   BMONTH                        N2PF.                               
