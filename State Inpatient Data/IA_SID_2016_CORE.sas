...
*  Data Step                  *;                                                
*******************************;                                                
DATA IA_SIDC_2016_CORE;                                                         
INFILE 'IA_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1376;                          
...
INPUT                                                                           
      ...
      @459    I10_DX49                      $CHAR7.                             
      @466    I10_DX50                      $CHAR7.                             
      @473    I10_ECAUSE1                   $CHAR7.                             
      @480    I10_ECAUSE2                   $CHAR7.                             
      @487    I10_ECAUSE3                   $CHAR7.                             
      @494    I10_ECAUSE4                   $CHAR7.                             
      @501    I10_ECAUSE5                   $CHAR7.                             
      @508    I10_ECAUSE6                   $CHAR7.                             
      @515    I10_NDX                       N3PF.                               
      @518    I10_NECAUSE                   N2PF.                               
      @520    I10_NPR                       N3PF.                               
      @523    I10_PR1                       $CHAR7.                             
      @530    I10_PR2                       $CHAR7.                             
      @537    I10_PR3                       $CHAR7.                             
      ...
      @873    PL_UIC                        N2PF.                               
      @875    PL_UR_CAT4                    N2PF.                               
      @877    POA_Disch_Edit1               N2PF.                               
      @879    POA_Disch_Edit2               N2PF.                               
      @881    POA_Hosp_Edit1                N2PF.                               
      @883    POA_Hosp_Edit2                N2PF.                               
      @885    POA_Hosp_Edit3                N2PF.                               
      @887    POA_Hosp_Edit3_Value          N8P2F.                              
      @895    PointOfOrigin_X               $CHAR1.                             
      @896    PointOfOriginUB04             $CHAR1.                             
      @897    PRDAY1                        N5PF.                               
      @902    PRDAY2                        N5PF.                               
      @907    PRDAY3                        N5PF.                               
      @912    PRDAY4                        N5PF.                               
