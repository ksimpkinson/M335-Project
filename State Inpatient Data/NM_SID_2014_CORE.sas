...
*  Data Step                  *;                                                
*******************************;                                                
DATA NM_SIDC_2014_CORE;                                                         
INFILE 'NM_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 758;                           
...
INPUT                                                                           
      ...
      @266    DXPOA18                       $CHAR1.                             
      @267    DXVER                         N3PF.                               
      @270    DX_Admitting                  $CHAR7.                             
      @277    DaysToEvent                   N6PF.                               
      @283    ECODE1                        $CHAR7.                             
      @290    ECODE2                        $CHAR7.                             
      @297    ECODE3                        $CHAR7.                             
      @304    ECODE4                        $CHAR7.                             
      ...
      @522    PL_UIC                        N2PF.                               
      @524    PL_UR_CAT4                    N2PF.                               
      @526    POA_Disch_Edit1               N2PF.                               
      @528    POA_Disch_Edit2               N2PF.                               
      @530    POA_Hosp_Edit1                N2PF.                               
      @532    POA_Hosp_Edit2                N2PF.                               
      @534    POA_Hosp_Edit3                N2PF.                               
      @536    POA_Hosp_Edit3_Value          N8P2F.                              
      @544    PR1                           $CHAR7.                             
      @551    PR2                           $CHAR7.                             
      @558    PR3                           $CHAR7.                             
      @565    PR4                           $CHAR7.                             
      ...
      @642    PSTCO                         N5PF.                               
      @647    PSTCO2                        N5PF.                               
      @652    PointOfOriginUB04             $CHAR1.                             
      @653    PointOfOrigin_X               $CHAR1.                             
      @654    RACE                          N2PF.                               
      @656    RACE_X                        $CHAR2.                             
      @658    SERVICELINE                   N2PF.                               
      @660    TOTCHG                        N10PF.                              
      @670    TOTCHG_X                      N15P2F.                             
      @685    TRAN_IN                       N2PF.                               
      @687    TRAN_OUT                      N2PF.                               
