...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SIDC_2010_CORE;                                                         
INFILE 'AR_SID_2010_CORE.ASC' FIRSTOBS=3 LRECL = 772;                           
