...
*  Data Step                  *;                                                
*******************************;                                                
DATA MS_SIDC_2011_DX_PR_GRPS;                                                   
INFILE 'MS_SID_2011_DX_PR_GRPS.ASC' LRECL = 412;                                
...
INPUT                                                                           
      ...
      @243    INJURY                   N2PF.                                    
      @245    INJURY_CUT               N2PF.                                    
      @247    INJURY_DROWN             N2PF.                                    
      @249    INJURY_FALL              N2PF.                                    
      @251    INJURY_FIRE              N2PF.                                    
      @253    INJURY_FIREARM           N2PF.                                    
      @255    INJURY_MACHINERY         N2PF.                                    
      @257    INJURY_MVT               N2PF.                                    
      @259    INJURY_NATURE            N2PF.                                    
      @261    INJURY_POISON            N2PF.                                    
      @263    INJURY_STRUCK            N2PF.                                    
      @265    INJURY_SUFFOCATION       N2PF.                                    
      @267    INTENT_ASSAULT           N2PF.                                    
      @269    INTENT_SELF_HARM         N2PF.                                    
      @271    INTENT_UNINTENTIONAL     N2PF.                                    
      @273    KEY                      18.                                      
      @291    MULTINJURY               N2PF.                                    
      @293    PCLASS1                  N2PF.                                    
      @295    PCLASS2                  N2PF.                                    
      ...
      @387    U_NEWBN4L                N2PF.                                    
      @389    U_NUCMED                 N2PF.                                    
      @391    U_OBSERVATION            N2PF.                                    
      @393    U_OCCTHERAPY             N2PF.                                    
      @395    U_ORGANACQ               N2PF.                                    
      @397    U_OTHIMPLANTS            N2PF.                                    
      @399    U_PACEMAKER              N2PF.                                    
      @401    U_PHYTHERAPY             N2PF.                                    
      @403    U_RADTHERAPY             N2PF.                                    
      @405    U_RESPTHERAPY            N2PF.                                    
      @407    U_SPEECHTHERAPY          N2PF.                                    
      @409    U_STRESS                 N2PF.                                    
      @411    U_ULTRASOUND             N2PF.                                    
      ;                                                                         
