...
*  Data Step                  *;                                                
*******************************;                                                
DATA FL_SIDC_2013_CORE;                                                         
INFILE 'FL_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1095;                          
...
INPUT                                                                           
      ...
      @511    PL_CBSA                  N3PF.                                    
      @514    PL_NCHS                  N2PF.                                    
      @516    PL_RUCA10_2005           N2PF.                                    
      @518    PL_RUCA2005              N4P1F.                                   
      @522    PL_RUCA4_2005            N2PF.                                    
      @524    PL_RUCC                  N2PF.                                    
      @526    PL_UIC                   N2PF.                                    
      @528    PL_UR_CAT4               N2PF.                                    
      @530    PR1                      $CHAR4.                                  
      ...
      @905    PSTATE                   $CHAR2.                                  
      @907    PSTCO2                   N5PF.                                    
      @912    PointOfOriginUB04        $CHAR1.                                  
      @913    PointOfOrigin_X          $CHAR2.                                  
      @915    RACE                     N2PF.                                    
      @917    RACE_X                   $CHAR1.                                  
      @918    TOTCHG                   N10PF.                                   
      @928    TOTCHG_X                 N15P2F.                                  
