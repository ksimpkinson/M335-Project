...
*  Data Step                  *;                                                
*******************************;                                                
DATA MI_SIDC_2013_CORE;                                                         
INFILE 'MI_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1177;                          
...
INPUT                                                                           
      ...
      @545    PL_CBSA                       N3PF.                               
      @548    PL_NCHS                       N2PF.                               
      @550    PL_RUCA10_2005                N2PF.                               
      @552    PL_RUCA2005                   N4P1F.                              
      @556    PL_RUCA4_2005                 N2PF.                               
      @558    PL_RUCC                       N2PF.                               
      @560    PL_UIC                        N2PF.                               
      @562    PL_UR_CAT4                    N2PF.                               
      @564    PR1                           $CHAR4.                             
      ...
      @927    PSTATE                        $CHAR2.                             
      @929    PSTCO2                        N5PF.                               
      @934    PointOfOriginUB04             $CHAR1.                             
      @935    PointOfOrigin_X               $CHAR1.                             
      @936    RACE                          N2PF.                               
      @938    RACE_X                        $CHAR1.                             
      @939    TOTCHG                        N10PF.                              
      @949    TOTCHG_X                      N15P2F.                             
