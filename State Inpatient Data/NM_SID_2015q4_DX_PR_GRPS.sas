...
*  Data Step                  *;                                                
*******************************;                                                
DATA NM_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'NM_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 508;                   
...
INPUT                                                                           
      ...
      @69     I10_CHRON17                   N2PF.                               
      @71     I10_CHRON18                   N2PF.                               
      @73     I10_DXMCCS1                   $CHAR11.                            
      @84     I10_DXMCCS2                   $CHAR11.                            
      @95     I10_DXMCCS3                   $CHAR11.                            
      @106    I10_DXMCCS4                   $CHAR11.                            
      @117    I10_DXMCCS5                   $CHAR11.                            
      @128    I10_DXMCCS6                   $CHAR11.                            
      @139    I10_DXMCCS7                   $CHAR11.                            
      @150    I10_DXMCCS8                   $CHAR11.                            
      @161    I10_DXMCCS9                   $CHAR11.                            
      @172    I10_DXMCCS10                  $CHAR11.                            
      @183    I10_DXMCCS11                  $CHAR11.                            
      @194    I10_DXMCCS12                  $CHAR11.                            
      @205    I10_DXMCCS13                  $CHAR11.                            
      @216    I10_DXMCCS14                  $CHAR11.                            
      @227    I10_DXMCCS15                  $CHAR11.                            
      @238    I10_DXMCCS16                  $CHAR11.                            
      @249    I10_DXMCCS17                  $CHAR11.                            
      @260    I10_DXMCCS18                  $CHAR11.                            
      @271    I10_ECauseMCCS1               $CHAR11.                            
      @282    I10_ECauseMCCS2               $CHAR11.                            
      @293    I10_ECauseMCCS3               $CHAR11.                            
      @304    I10_ECauseMCCS4               $CHAR11.                            
      @315    I10_ECauseMCCS5               $CHAR11.                            
      @326    I10_ECauseMCCS6               $CHAR11.                            
      @337    I10_ECauseMCCS7               $CHAR11.                            
      @348    I10_ECauseMCCS8               $CHAR11.                            
      @359    I10_ECauseMCCS9               $CHAR11.                            
      @370    I10_INJURY                    N2PF.                               
      @372    I10_MULTINJURY                N2PF.                               
      @374    I10_PCLASS1                   N2PF.                               
      @376    I10_PCLASS2                   N2PF.                               
      @378    I10_PCLASS3                   N2PF.                               
      @380    I10_PCLASS4                   N2PF.                               
      @382    I10_PCLASS5                   N2PF.                               
      @384    I10_PCLASS6                   N2PF.                               
      @386    I10_PRMCCS1                   $CHAR8.                             
      @394    I10_PRMCCS2                   $CHAR8.                             
      @402    I10_PRMCCS3                   $CHAR8.                             
      @410    I10_PRMCCS4                   $CHAR8.                             
      @418    I10_PRMCCS5                   $CHAR8.                             
      @426    I10_PRMCCS6                   $CHAR8.                             
      @434    I10_U_BLOOD                   N2PF.                               
      @436    I10_U_CATH                    N2PF.                               
      @438    I10_U_CTSCAN                  N2PF.                               
      @440    I10_U_EKG                     N2PF.                               
      @442    I10_U_MHSA                    N2PF.                               
      @444    I10_U_MRT                     N2PF.                               
      @446    I10_U_PACEMAKER               N2PF.                               
      @448    I10_U_PHYTHERAPY              N2PF.                               
      @450    I10_U_RADTHERAPY              N2PF.                               
      @452    I10_U_STRESS                  N2PF.                               
      @454    KEY                           15.                                 
      @469    U_CCU                         N2PF.                               
      @471    U_CHESTXRAY                   N2PF.                               
      @473    U_DIALYSIS                    N2PF.                               
      @475    U_ECHO                        N2PF.                               
      @477    U_ED                          N2PF.                               
      @479    U_EEG                         N2PF.                               
      @481    U_EPO                         N2PF.                               
      @483    U_ICU                         N2PF.                               
      @485    U_LITHOTRIPSY                 N2PF.                               
      @487    U_NEWBN2L                     N2PF.                               
      @489    U_NEWBN3L                     N2PF.                               
      @491    U_NEWBN4L                     N2PF.                               
      @493    U_NUCMED                      N2PF.                               
      @495    U_OBSERVATION                 N2PF.                               
      @497    U_OCCTHERAPY                  N2PF.                               
      @499    U_ORGANACQ                    N2PF.                               
      @501    U_OTHIMPLANTS                 N2PF.                               
      @503    U_RESPTHERAPY                 N2PF.                               
      @505    U_SPEECHTHERAPY               N2PF.                               
      @507    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
