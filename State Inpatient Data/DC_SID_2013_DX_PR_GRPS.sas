...
*  Data Step                  *;                                                
*******************************;                                                
DATA DC_SIDC_2013_DX_PR_GRPS;                                                   
INFILE 'DC_SID_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 702;                     
...
INPUT                                                                           
      ...
      @416    INJURY                        N2PF.                               
      @418    INJURY_CUT                    N2PF.                               
      @420    INJURY_DROWN                  N2PF.                               
      @422    INJURY_FALL                   N2PF.                               
      @424    INJURY_FIRE                   N2PF.                               
      @426    INJURY_FIREARM                N2PF.                               
      @428    INJURY_MACHINERY              N2PF.                               
      @430    INJURY_MVT                    N2PF.                               
      @432    INJURY_NATURE                 N2PF.                               
      @434    INJURY_POISON                 N2PF.                               
      @436    INJURY_STRUCK                 N2PF.                               
      @438    INJURY_SUFFOCATION            N2PF.                               
      @440    INTENT_ASSAULT                N2PF.                               
      @442    INTENT_SELF_HARM              N2PF.                               
      @444    INTENT_UNINTENTIONAL          N2PF.                               
      @446    KEY                           15.                                 
      @461    MULTINJURY                    N2PF.                               
      @463    PCLASS1                       N2PF.                               
      @465    PCLASS2                       N2PF.                               
