...
*  Data Step                  *;                                                
*******************************;                                                
DATA GA_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'GA_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 1428;                  
...
INPUT                                                                           
      ...
      @828    I10_ECauseMCCS8               $CHAR11.                            
      @839    I10_ECauseMCCS9               $CHAR11.                            
      @850    I10_INJURY                    N2PF.                               
      @852    I10_MULTINJURY                N2PF.                               
      @854    I10_PCLASS1                   N2PF.                               
      @856    I10_PCLASS2                   N2PF.                               
      @858    I10_PCLASS3                   N2PF.                               
      @860    I10_PCLASS4                   N2PF.                               
      @862    I10_PCLASS5                   N2PF.                               
      @864    I10_PCLASS6                   N2PF.                               
      @866    I10_PCLASS7                   N2PF.                               
      @868    I10_PCLASS8                   N2PF.                               
      @870    I10_PCLASS9                   N2PF.                               
      @872    I10_PCLASS10                  N2PF.                               
      @874    I10_PCLASS11                  N2PF.                               
      @876    I10_PCLASS12                  N2PF.                               
      @878    I10_PCLASS13                  N2PF.                               
      @880    I10_PCLASS14                  N2PF.                               
      @882    I10_PCLASS15                  N2PF.                               
      @884    I10_PCLASS16                  N2PF.                               
      @886    I10_PCLASS17                  N2PF.                               
      @888    I10_PCLASS18                  N2PF.                               
      @890    I10_PCLASS19                  N2PF.                               
      @892    I10_PCLASS20                  N2PF.                               
      @894    I10_PCLASS21                  N2PF.                               
      @896    I10_PCLASS22                  N2PF.                               
      @898    I10_PCLASS23                  N2PF.                               
      @900    I10_PCLASS24                  N2PF.                               
      @902    I10_PCLASS25                  N2PF.                               
      @904    I10_PCLASS26                  N2PF.                               
      @906    I10_PCLASS27                  N2PF.                               
      @908    I10_PCLASS28                  N2PF.                               
      @910    I10_PCLASS29                  N2PF.                               
      @912    I10_PCLASS30                  N2PF.                               
      @914    I10_PCLASS31                  N2PF.                               
      @916    I10_PCLASS32                  N2PF.                               
      @918    I10_PCLASS33                  N2PF.                               
      @920    I10_PCLASS34                  N2PF.                               
      @922    I10_PCLASS35                  N2PF.                               
      @924    I10_PCLASS36                  N2PF.                               
      @926    I10_PCLASS37                  N2PF.                               
      @928    I10_PCLASS38                  N2PF.                               
      @930    I10_PCLASS39                  N2PF.                               
      @932    I10_PCLASS40                  N2PF.                               
      @934    I10_PCLASS41                  N2PF.                               
      @936    I10_PCLASS42                  N2PF.                               
      @938    I10_PCLASS43                  N2PF.                               
      @940    I10_PCLASS44                  N2PF.                               
      @942    I10_PCLASS45                  N2PF.                               
      @944    I10_PCLASS46                  N2PF.                               
      @946    I10_PCLASS47                  N2PF.                               
      @948    I10_PCLASS48                  N2PF.                               
      @950    I10_PCLASS49                  N2PF.                               
      @952    I10_PCLASS50                  N2PF.                               
      @954    I10_PRMCCS1                   $CHAR8.                             
      @962    I10_PRMCCS2                   $CHAR8.                             
      @970    I10_PRMCCS3                   $CHAR8.                             
      @978    I10_PRMCCS4                   $CHAR8.                             
      @986    I10_PRMCCS5                   $CHAR8.                             
      @994    I10_PRMCCS6                   $CHAR8.                             
      @1002   I10_PRMCCS7                   $CHAR8.                             
      @1010   I10_PRMCCS8                   $CHAR8.                             
      @1018   I10_PRMCCS9                   $CHAR8.                             
      @1026   I10_PRMCCS10                  $CHAR8.                             
      @1034   I10_PRMCCS11                  $CHAR8.                             
      @1042   I10_PRMCCS12                  $CHAR8.                             
      @1050   I10_PRMCCS13                  $CHAR8.                             
      @1058   I10_PRMCCS14                  $CHAR8.                             
      @1066   I10_PRMCCS15                  $CHAR8.                             
      @1074   I10_PRMCCS16                  $CHAR8.                             
      @1082   I10_PRMCCS17                  $CHAR8.                             
      @1090   I10_PRMCCS18                  $CHAR8.                             
      @1098   I10_PRMCCS19                  $CHAR8.                             
      @1106   I10_PRMCCS20                  $CHAR8.                             
      @1114   I10_PRMCCS21                  $CHAR8.                             
      @1122   I10_PRMCCS22                  $CHAR8.                             
      @1130   I10_PRMCCS23                  $CHAR8.                             
      @1138   I10_PRMCCS24                  $CHAR8.                             
      @1146   I10_PRMCCS25                  $CHAR8.                             
      @1154   I10_PRMCCS26                  $CHAR8.                             
      @1162   I10_PRMCCS27                  $CHAR8.                             
      @1170   I10_PRMCCS28                  $CHAR8.                             
      @1178   I10_PRMCCS29                  $CHAR8.                             
      @1186   I10_PRMCCS30                  $CHAR8.                             
      @1194   I10_PRMCCS31                  $CHAR8.                             
      @1202   I10_PRMCCS32                  $CHAR8.                             
      @1210   I10_PRMCCS33                  $CHAR8.                             
      @1218   I10_PRMCCS34                  $CHAR8.                             
      @1226   I10_PRMCCS35                  $CHAR8.                             
      @1234   I10_PRMCCS36                  $CHAR8.                             
      @1242   I10_PRMCCS37                  $CHAR8.                             
      @1250   I10_PRMCCS38                  $CHAR8.                             
      @1258   I10_PRMCCS39                  $CHAR8.                             
      @1266   I10_PRMCCS40                  $CHAR8.                             
      @1274   I10_PRMCCS41                  $CHAR8.                             
      @1282   I10_PRMCCS42                  $CHAR8.                             
      @1290   I10_PRMCCS43                  $CHAR8.                             
      @1298   I10_PRMCCS44                  $CHAR8.                             
      @1306   I10_PRMCCS45                  $CHAR8.                             
      @1314   I10_PRMCCS46                  $CHAR8.                             
      @1322   I10_PRMCCS47                  $CHAR8.                             
      @1330   I10_PRMCCS48                  $CHAR8.                             
      @1338   I10_PRMCCS49                  $CHAR8.                             
      @1346   I10_PRMCCS50                  $CHAR8.                             
      @1354   I10_U_BLOOD                   N2PF.                               
      @1356   I10_U_CATH                    N2PF.                               
      @1358   I10_U_CTSCAN                  N2PF.                               
      @1360   I10_U_EKG                     N2PF.                               
      @1362   I10_U_MHSA                    N2PF.                               
      @1364   I10_U_MRT                     N2PF.                               
      @1366   I10_U_PACEMAKER               N2PF.                               
      @1368   I10_U_PHYTHERAPY              N2PF.                               
      @1370   I10_U_RADTHERAPY              N2PF.                               
      @1372   I10_U_STRESS                  N2PF.                               
      @1374   KEY                           15.                                 
      @1389   U_CCU                         N2PF.                               
      @1391   U_CHESTXRAY                   N2PF.                               
      @1393   U_DIALYSIS                    N2PF.                               
      @1395   U_ECHO                        N2PF.                               
      @1397   U_ED                          N2PF.                               
      @1399   U_EEG                         N2PF.                               
      @1401   U_EPO                         N2PF.                               
      @1403   U_ICU                         N2PF.                               
      @1405   U_LITHOTRIPSY                 N2PF.                               
      @1407   U_NEWBN2L                     N2PF.                               
      @1409   U_NEWBN3L                     N2PF.                               
      @1411   U_NEWBN4L                     N2PF.                               
      @1413   U_NUCMED                      N2PF.                               
      @1415   U_OBSERVATION                 N2PF.                               
      @1417   U_OCCTHERAPY                  N2PF.                               
      @1419   U_ORGANACQ                    N2PF.                               
      @1421   U_OTHIMPLANTS                 N2PF.                               
      @1423   U_RESPTHERAPY                 N2PF.                               
      @1425   U_SPEECHTHERAPY               N2PF.                               
      @1427   U_ULTRASOUND                  N2PF.                               
      ;                                                                         
