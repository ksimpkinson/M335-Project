...
*  Data Step                  *;                                                
*******************************;                                                
DATA MI_SIDC_2014_CORE;                                                         
INFILE 'MI_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1365;                          
...
INPUT                                                                           
      ...
      @635    PL_UIC                        N2PF.                               
      @637    PL_UR_CAT4                    N2PF.                               
      @639    POA_Disch_Edit1               N2PF.                               
      @641    POA_Disch_Edit2               N2PF.                               
      @643    POA_Hosp_Edit1                N2PF.                               
      @645    POA_Hosp_Edit2                N2PF.                               
      @647    POA_Hosp_Edit3                N2PF.                               
      @649    POA_Hosp_Edit3_Value          N8P2F.                              
      @657    PR1                           $CHAR7.                             
      @664    PR2                           $CHAR7.                             
      @671    PR3                           $CHAR7.                             
      @678    PR4                           $CHAR7.                             
      ...
      @1113   PSTATE                        $CHAR2.                             
      @1115   PSTCO2                        N5PF.                               
      @1120   PointOfOriginUB04             $CHAR1.                             
      @1121   PointOfOrigin_X               $CHAR1.                             
      @1122   RACE                          N2PF.                               
      @1124   RACE_X                        $CHAR1.                             
      @1125   SERVICELINE                   N2PF.                               
      @1127   TOTCHG                        N10PF.                              
      @1137   TOTCHG_X                      N15P2F.                             
      @1152   TRAN_IN                       N2PF.                               
      @1154   TRAN_OUT                      N2PF.                               
      @1156   YEAR                          N4PF.                               
      @1160   ZIP                           $CHAR5.                             
      @1165   ZIP3                          $CHAR3.                             
      @1168   ZIPINC_QRTL                   N3PF.                               
      @1171   HOSPID                        N5PF.                               
      @1176   AYEAR                         N4PF.                               
      @1180   BMONTH                        N2PF.                               
      @1182   BYEAR                         N4PF.                               
