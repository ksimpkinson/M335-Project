...
*  Data Step                  *;                                                
*******************************;                                                
DATA WV_SIDC_2013_DX_PR_GRPS;                                                   
INFILE 'WV_SID_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 525;                     
...
INPUT                                                                           
      ...
      @359    INJURY                        N2PF.                               
      @361    INJURY_CUT                    N2PF.                               
      @363    INJURY_DROWN                  N2PF.                               
      @365    INJURY_FALL                   N2PF.                               
      @367    INJURY_FIRE                   N2PF.                               
      @369    INJURY_FIREARM                N2PF.                               
      @371    INJURY_MACHINERY              N2PF.                               
      @373    INJURY_MVT                    N2PF.                               
      @375    INJURY_NATURE                 N2PF.                               
      @377    INJURY_POISON                 N2PF.                               
      @379    INJURY_STRUCK                 N2PF.                               
      @381    INJURY_SUFFOCATION            N2PF.                               
      @383    INTENT_ASSAULT                N2PF.                               
      @385    INTENT_SELF_HARM              N2PF.                               
      @387    INTENT_UNINTENTIONAL          N2PF.                               
      @389    KEY                           15.                                 
      @404    MULTINJURY                    N2PF.                               
      @406    PCLASS1                       N2PF.                               
      @408    PCLASS2                       N2PF.                               
      ...
      @500    U_NEWBN4L                     N2PF.                               
      @502    U_NUCMED                      N2PF.                               
      @504    U_OBSERVATION                 N2PF.                               
      @506    U_OCCTHERAPY                  N2PF.                               
      @508    U_ORGANACQ                    N2PF.                               
      @510    U_OTHIMPLANTS                 N2PF.                               
      @512    U_PACEMAKER                   N2PF.                               
      @514    U_PHYTHERAPY                  N2PF.                               
      @516    U_RADTHERAPY                  N2PF.                               
      @518    U_RESPTHERAPY                 N2PF.                               
      @520    U_SPEECHTHERAPY               N2PF.                               
      @522    U_STRESS                      N2PF.                               
      @524    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
