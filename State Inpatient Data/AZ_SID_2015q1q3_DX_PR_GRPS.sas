...
*   AZ_SID_2015q1q3_DX_PR_GRPS.SAS:                                             
...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SIDC_2015q1q3_DX_PR_GRPS;                                               
INFILE 'AZ_SID_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 608;                 
...
INPUT                                                                           
      ...
      @442    INJURY                        N2PF.                               
      @444    INJURY_CUT                    N2PF.                               
      @446    INJURY_DROWN                  N2PF.                               
      @448    INJURY_FALL                   N2PF.                               
      @450    INJURY_FIRE                   N2PF.                               
      @452    INJURY_FIREARM                N2PF.                               
      @454    INJURY_MACHINERY              N2PF.                               
      @456    INJURY_MVT                    N2PF.                               
      @458    INJURY_NATURE                 N2PF.                               
      @460    INJURY_POISON                 N2PF.                               
      @462    INJURY_STRUCK                 N2PF.                               
      @464    INJURY_SUFFOCATION            N2PF.                               
      @466    INTENT_ASSAULT                N2PF.                               
      @468    INTENT_SELF_HARM              N2PF.                               
      @470    INTENT_UNINTENTIONAL          N2PF.                               
      @472    KEY                           15.                                 
      @487    MULTINJURY                    N2PF.                               
      @489    PCLASS1                       N2PF.                               
      @491    PCLASS2                       N2PF.                               
