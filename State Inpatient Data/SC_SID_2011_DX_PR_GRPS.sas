...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2011_DX_PR_GRPS;                                                   
INFILE 'SC_SID_2011_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 523;                     
...
INPUT                                                                           
      ...
      @347    INJURY                        N2PF.                               
      @349    INJURY_CUT                    N2PF.                               
      @351    INJURY_DROWN                  N2PF.                               
      @353    INJURY_FALL                   N2PF.                               
      @355    INJURY_FIRE                   N2PF.                               
      @357    INJURY_FIREARM                N2PF.                               
      @359    INJURY_MACHINERY              N2PF.                               
      @361    INJURY_MVT                    N2PF.                               
      @363    INJURY_NATURE                 N2PF.                               
      @365    INJURY_POISON                 N2PF.                               
      @367    INJURY_STRUCK                 N2PF.                               
      @369    INJURY_SUFFOCATION            N2PF.                               
      @371    INTENT_ASSAULT                N2PF.                               
      @373    INTENT_SELF_HARM              N2PF.                               
      @375    INTENT_UNINTENTIONAL          N2PF.                               
      @377    KEY                           15.                                 
      @392    MULTINJURY                    N2PF.                               
      @394    PCLASS1                       N2PF.                               
      @396    PCLASS2                       N2PF.                               
