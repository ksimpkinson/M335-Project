...
*  Data Step                  *;                                                
*******************************;                                                
DATA WA_SIDC_2013_CORE;                                                         
INFILE 'WA_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 919;                           
...
INPUT                                                                           
      ...
      @846    PSTATE                        $CHAR2.                             
      @848    PSTCO2                        N5PF.                               
      @853    PointOfOriginUB04             $CHAR1.                             
      @854    PointOfOrigin_X               $CHAR1.                             
      @855    RACE                          N2PF.                               
      @857    RACE_X                        $CHAR6.                             
      @863    TOTCHG                        N10PF.                              
      @873    TOTCHG_X                      N15P2F.                             
