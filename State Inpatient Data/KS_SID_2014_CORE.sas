...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SIDC_2014_CORE;                                                         
INFILE 'KS_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1268;                          
...
INPUT                                                                           
      ...
      @560    HCUP_ED                       N2PF.                               
      @562    HCUP_OS                       N2PF.                               
      @564    HISPANIC_X                    $CHAR1.                             
      @565    HOSPBRTH                      N3PF.                               
      @568    HOSPST                        $CHAR2.                             
      @570    HospitalUnit                  N2PF.                               
      @572    KEY                           15.                                 
      @587    LOS                           N5PF.                               
      @592    LOS_X                         N6PF.                               
      @598    MDC                           N2PF.                               
      ...
      @643    PL_UIC                        N2PF.                               
      @645    PL_UR_CAT4                    N2PF.                               
      @647    POA_Disch_Edit1               N2PF.                               
      @649    POA_Disch_Edit2               N2PF.                               
      @651    POA_Hosp_Edit1                N2PF.                               
      @653    POA_Hosp_Edit2                N2PF.                               
      @655    POA_Hosp_Edit3                N2PF.                               
      @657    POA_Hosp_Edit3_Value          N8P2F.                              
      @665    PR1                           $CHAR7.                             
      @672    PR2                           $CHAR7.                             
      @679    PR3                           $CHAR7.                             
      @686    PR4                           $CHAR7.                             
      ...
      @1059   PointOfOrigin_X               $CHAR1.                             
      @1060   RACE                          N2PF.                               
      @1062   RACE_X                        $CHAR1.                             
      @1063   SERVICELINE                   N2PF.                               
      @1065   TOTCHG                        N10PF.                              
      @1075   TOTCHG_X                      N15P2F.                             
      @1090   TRAN_IN                       N2PF.                               
      @1092   TRAN_OUT                      N2PF.                               
      @1094   YEAR                          N4PF.                               
      @1098   ZIP3                          $CHAR3.                             
      @1101   ZIPINC_QRTL                   N3PF.                               
      @1104   HOSPID                        N5PF.                               
      @1109   AYEAR                         N4PF.                               
      @1113   BMONTH                        N2PF.                               
      @1115   BYEAR                         N4PF.                               
