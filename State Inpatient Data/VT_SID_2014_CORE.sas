...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SIDC_2014_CORE;                                                         
INFILE 'VT_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1832;                          
...
INPUT                                                                           
      ...
      @1057   DXPOA20                       $CHAR1.                             
      @1058   DXVER                         N3PF.                               
      @1061   DX_Admitting                  $CHAR7.                             
      @1068   DaysToEvent                   N6PF.                               
      @1074   ECODE1                        $CHAR7.                             
      @1081   ECODE2                        $CHAR7.                             
      @1088   ECODE3                        $CHAR7.                             
      @1095   ECODE4                        $CHAR7.                             
      ...
      @1184   HCUP_ED                       N2PF.                               
      @1186   HCUP_OS                       N2PF.                               
      @1188   HISPANIC_X                    $CHAR1.                             
      @1189   HOSPBRTH                      N3PF.                               
      @1192   HOSPST                        $CHAR2.                             
      @1194   HOSP_NPI                      $CHAR10.                            
      @1204   KEY                           15.                                 
      @1219   LOS                           N5PF.                               
      @1224   LOS_X                         N6PF.                               
      @1230   MDC                           N2PF.                               
      ...
      @1295   PL_RUCC                       N2PF.                               
      @1297   PL_UIC                        N2PF.                               
      @1299   PL_UR_CAT4                    N2PF.                               
      @1301   POA_Disch_Edit1               N2PF.                               
      @1303   POA_Disch_Edit2               N2PF.                               
      @1305   POA_Hosp_Edit1                N2PF.                               
      @1307   POA_Hosp_Edit2                N2PF.                               
      @1309   POA_Hosp_Edit3                N2PF.                               
      @1311   POA_Hosp_Edit3_Value          N8P2F.                              
      @1319   PR1                           $CHAR7.                             
      @1326   PR2                           $CHAR7.                             
      @1333   PR3                           $CHAR7.                             
      @1340   PR4                           $CHAR7.                             
      ...
      @1638   PointOfOrigin_X               $CHAR1.                             
      @1639   RACE                          N2PF.                               
      @1641   RACE_X                        $CHAR1.                             
      @1642   READMIT                       N2PF.                               
      @1644   SERVICELINE                   N2PF.                               
      @1646   TOTCHG                        N10PF.                              
      @1656   TOTCHG_X                      N15P2F.                             
      @1671   TRAN_IN                       N2PF.                               
      @1673   TRAN_OUT                      N2PF.                               
      @1675   VisitLink                     N9PF.                               
      @1684   YEAR                          N4PF.                               
