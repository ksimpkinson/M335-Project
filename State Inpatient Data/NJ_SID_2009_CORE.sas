...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SIDC_2009_CORE;                                                         
INFILE 'NJ_SID_2009_CORE.ASC' LRECL = 1427;                                     
...
INPUT                                                                           
      ...
      @875    PL_CBSA                  N3PF.                                    
      @878    PL_MSA1993               N3PF.                                    
      @881    PL_NCHS2006              N2PF.                                    
      @883    PL_RUCA10_2005           N2PF.                                    
      @885    PL_RUCA2005              N4P1F.                                   
      @889    PL_RUCA4_2005            N2PF.                                    
      @891    PL_RUCC2003              N2PF.                                    
      @893    PL_UIC2003               N2PF.                                    
      @895    PL_UR_CAT4               N2PF.                                    
      @897    PR1                      $CHAR4.                                  
      @901    PR2                      $CHAR4.                                  
      ...
      @1202   PSTCO                    N5PF.                                    
      @1207   PSTCO2                   N5PF.                                    
      @1212   PointOfOriginUB04        $CHAR1.                                  
      @1213   PointOfOrigin_X          $CHAR1.                                  
      @1214   PrimLang                 $CHAR3.                                  
      @1217   RACE                     N2PF.                                    
      @1219   RACE_X                   $CHAR5.                                  
      @1224   READMIT                  N2PF.                                    
      @1226   TOTCHG                   N10PF.                                   
      @1236   TOTCHG_X                 N15P2F.                                  
      @1251   TRAN_IN                  N2PF.                                    
      @1253   TRAN_OUT                 N2PF.                                    
      @1255   YEAR                     N4PF.                                    
      @1259   ZIP3                     $CHAR3.                                  
