...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SIDC_2014_CORE;                                                         
INFILE 'KY_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1204;                          
...
INPUT                                                                           
      ...
      @580    PL_UIC                        N2PF.                               
      @582    PL_UR_CAT4                    N2PF.                               
      @584    POA_Disch_Edit1               N2PF.                               
      @586    POA_Disch_Edit2               N2PF.                               
      @588    POA_Hosp_Edit1                N2PF.                               
      @590    POA_Hosp_Edit2                N2PF.                               
      @592    POA_Hosp_Edit3                N2PF.                               
      @594    POA_Hosp_Edit3_Value          N8P2F.                              
      @602    PR1                           $CHAR7.                             
      @609    PR2                           $CHAR7.                             
      @616    PR3                           $CHAR7.                             
      @623    PR4                           $CHAR7.                             
      ...
      @985    PSTCO                         N5PF.                               
      @990    PSTCO2                        N5PF.                               
      @995    PointOfOriginUB04             $CHAR1.                             
      @996    PointOfOrigin_X               $CHAR2.                             
      @998    RACE                          N2PF.                               
      @1000   RACE_X                        $CHAR2.                             
      @1002   SERVICELINE                   N2PF.                               
      @1004   TOTCHG                        N10PF.                              
