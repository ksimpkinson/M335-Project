...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SIDC_2013_CORE;                                                         
INFILE 'AR_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 806;                           
...
INPUT                                                                           
      ...
      @290    DXPOA17                       $CHAR1.                             
      @291    DXPOA18                       $CHAR1.                             
      @292    DX_Admitting                  $CHAR7.                             
      @299    DaysToEvent                   N6PF.                               
      @305    ECODE1                        $CHAR7.                             
      @312    ECODE2                        $CHAR7.                             
      @319    ECODE3                        $CHAR7.                             
      @326    ECODE4                        $CHAR7.                             
      ...
      @427    HCUP_ED                       N2PF.                               
      @429    HCUP_OS                       N2PF.                               
      @431    HISPANIC_X                    $CHAR1.                             
      @432    HOSPBRTH                      N3PF.                               
      @435    HOSPST                        $CHAR2.                             
      @437    KEY                           15.                                 
      @452    LOS                           N5PF.                               
      @457    LOS_X                         N6PF.                               
      @463    MARITALSTATUSUB04             $CHAR1.                             
      @464    MARITALSTATUS_X               $CHAR1.                             
      @465    MDC                           N2PF.                               
      @467    MDC24                         N2PF.                               
      @469    MDC_NoPOA                     N2PF.                               
      @471    MDNUM1_R                      N9PF.                               
      ...
      @554    PL_CBSA                       N3PF.                               
      @557    PL_NCHS                       N2PF.                               
      @559    PL_RUCA10_2005                N2PF.                               
      @561    PL_RUCA2005                   N4P1F.                              
      @565    PL_RUCA4_2005                 N2PF.                               
      @567    PL_RUCC                       N2PF.                               
      @569    PL_UIC                        N2PF.                               
      @571    PL_UR_CAT4                    N2PF.                               
      @573    PR1                           $CHAR7.                             
