...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SIDC_2016_CORE;                                                         
INFILE 'UT_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1206;                          
...
INPUT                                                                           
      ...
      @670    HCUP_ED                       N2PF.                               
      @672    HCUP_OS                       N2PF.                               
      @674    HISPANIC_X                    $CHAR1.                             
      @675    Homeless                      N2PF.                               
      @677    HOSPST                        $CHAR2.                             
      @679    I10_DX_Admitting              $CHAR7.                             
      @686    I10_DX1                       $CHAR7.                             
      @693    I10_DX2                       $CHAR7.                             
      @700    I10_DX3                       $CHAR7.                             
      @707    I10_DX4                       $CHAR7.                             
      ...
      @819    I10_DX20                      $CHAR7.                             
      @826    I10_DX21                      $CHAR7.                             
      @833    I10_ECAUSE1                   $CHAR7.                             
      @840    I10_ECAUSE2                   $CHAR7.                             
      @847    I10_ECAUSE3                   $CHAR7.                             
      @854    I10_ECAUSE4                   $CHAR7.                             
      @861    I10_ECAUSE5                   $CHAR7.                             
      @868    I10_ECAUSE6                   $CHAR7.                             
      @875    I10_ECAUSE7                   $CHAR7.                             
      @882    I10_ECAUSE8                   $CHAR7.                             
      @889    I10_NDX                       N3PF.                               
      @892    I10_NECAUSE                   N2PF.                               
      @894    I10_NPR                       N3PF.                               
      @897    I10_PR1                       $CHAR7.                             
      @904    I10_PR2                       $CHAR7.                             
      @911    I10_PR3                       $CHAR7.                             
      ...
      @925    I10_PR5                       $CHAR7.                             
      @932    I10_PR6                       $CHAR7.                             
      @939    I10_PROCTYPE                  N3PF.                               
      @942    KEY                           15.                                 
      @957    LOS                           N5PF.                               
      @962    LOS_X                         N6PF.                               
      @968    MARITALSTATUS_X               $CHAR1.                             
      @969    MARITALSTATUSUB04             $CHAR1.                             
      @970    MDC                           N2PF.                               
      @972    MDC_NoPOA                     N2PF.                               
      @974    MDNUM1_R                      N9PF.                               
      @983    MDSPEC1                       $CHAR10.                            
      ...
      @1059   PL_RUCC                       N2PF.                               
      @1061   PL_UIC                        N2PF.                               
      @1063   PL_UR_CAT4                    N2PF.                               
      @1065   PointOfOrigin_X               $CHAR1.                             
      @1066   PointOfOriginUB04             $CHAR1.                             
      @1067   PRDAY1                        N5PF.                               
      @1072   PRDAY2                        N5PF.                               
      @1077   PRDAY3                        N5PF.                               
      @1082   PRDAY4                        N5PF.                               
