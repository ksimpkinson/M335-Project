...
*  Data Step                  *;                                                
*******************************;                                                
DATA NC_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'NC_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 731;                   
...
INPUT                                                                           
      ...
      @487    I10_PCLASS16                  N2PF.                               
      @489    I10_PCLASS17                  N2PF.                               
      @491    I10_PCLASS18                  N2PF.                               
      @493    I10_PCLASS19                  N2PF.                               
      @495    I10_PCLASS20                  N2PF.                               
      @497    I10_PRMCCS1                   $CHAR8.                             
      @505    I10_PRMCCS2                   $CHAR8.                             
      @513    I10_PRMCCS3                   $CHAR8.                             
      @521    I10_PRMCCS4                   $CHAR8.                             
      @529    I10_PRMCCS5                   $CHAR8.                             
      @537    I10_PRMCCS6                   $CHAR8.                             
      @545    I10_PRMCCS7                   $CHAR8.                             
      @553    I10_PRMCCS8                   $CHAR8.                             
      @561    I10_PRMCCS9                   $CHAR8.                             
      @569    I10_PRMCCS10                  $CHAR8.                             
      @577    I10_PRMCCS11                  $CHAR8.                             
      @585    I10_PRMCCS12                  $CHAR8.                             
      @593    I10_PRMCCS13                  $CHAR8.                             
      @601    I10_PRMCCS14                  $CHAR8.                             
      @609    I10_PRMCCS15                  $CHAR8.                             
      @617    I10_PRMCCS16                  $CHAR8.                             
      @625    I10_PRMCCS17                  $CHAR8.                             
      @633    I10_PRMCCS18                  $CHAR8.                             
      @641    I10_PRMCCS19                  $CHAR8.                             
      @649    I10_PRMCCS20                  $CHAR8.                             
      @657    I10_U_BLOOD                   N2PF.                               
      @659    I10_U_CATH                    N2PF.                               
      @661    I10_U_CTSCAN                  N2PF.                               
      @663    I10_U_EKG                     N2PF.                               
      @665    I10_U_MHSA                    N2PF.                               
      @667    I10_U_MRT                     N2PF.                               
      @669    I10_U_PACEMAKER               N2PF.                               
      @671    I10_U_PHYTHERAPY              N2PF.                               
      @673    I10_U_RADTHERAPY              N2PF.                               
      @675    I10_U_STRESS                  N2PF.                               
      @677    KEY                           15.                                 
      @692    U_CCU                         N2PF.                               
      @694    U_CHESTXRAY                   N2PF.                               
      @696    U_DIALYSIS                    N2PF.                               
      @698    U_ECHO                        N2PF.                               
      @700    U_ED                          N2PF.                               
      @702    U_EEG                         N2PF.                               
      @704    U_EPO                         N2PF.                               
      @706    U_ICU                         N2PF.                               
      @708    U_LITHOTRIPSY                 N2PF.                               
      @710    U_NEWBN2L                     N2PF.                               
      @712    U_NEWBN3L                     N2PF.                               
      @714    U_NEWBN4L                     N2PF.                               
      @716    U_NUCMED                      N2PF.                               
      @718    U_OBSERVATION                 N2PF.                               
      @720    U_OCCTHERAPY                  N2PF.                               
      @722    U_ORGANACQ                    N2PF.                               
      @724    U_OTHIMPLANTS                 N2PF.                               
      @726    U_RESPTHERAPY                 N2PF.                               
      @728    U_SPEECHTHERAPY               N2PF.                               
      @730    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
