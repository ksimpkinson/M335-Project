...
*  Data Step                  *;                                                
*******************************;                                                
DATA GA_SIDC_2011_DX_PR_GRPS;                                                   
INFILE 'GA_SID_2011_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 1055;                    
...
ATTRIB                                                                          
  ...
  E_MCCS17                   LENGTH=$11                                         
  LABEL="Multi-Level CCS:  E Code 17"                                           
                                                                                
  E_MCCS18                   LENGTH=$11                                         
  LABEL="Multi-Level CCS:  E Code 18"                                           
...
INPUT                                                                           
      ...
      @649    INJURY                        N2PF.                               
      @651    INJURY_CUT                    N2PF.                               
      @653    INJURY_DROWN                  N2PF.                               
      @655    INJURY_FALL                   N2PF.                               
      @657    INJURY_FIRE                   N2PF.                               
      @659    INJURY_FIREARM                N2PF.                               
      @661    INJURY_MACHINERY              N2PF.                               
      @663    INJURY_MVT                    N2PF.                               
      @665    INJURY_NATURE                 N2PF.                               
      @667    INJURY_POISON                 N2PF.                               
      @669    INJURY_STRUCK                 N2PF.                               
      @671    INJURY_SUFFOCATION            N2PF.                               
      @673    INTENT_ASSAULT                N2PF.                               
      @675    INTENT_SELF_HARM              N2PF.                               
      @677    INTENT_UNINTENTIONAL          N2PF.                               
      @679    KEY                           15.                                 
      @694    MULTINJURY                    N2PF.                               
      @696    PCLASS1                       N2PF.                               
      @698    PCLASS2                       N2PF.                               
      ...
      @998    U_CATH                        N2PF.                               
      @1000   U_CCU                         N2PF.                               
      @1002   U_CHESTXRAY                   N2PF.                               
      @1004   U_CTSCAN                      N2PF.                               
      @1006   U_DIALYSIS                    N2PF.                               
      @1008   U_ECHO                        N2PF.                               
      @1010   U_ED                          N2PF.                               
      @1012   U_EEG                         N2PF.                               
      @1014   U_EKG                         N2PF.                               
      ...
      @1030   U_NEWBN4L                     N2PF.                               
      @1032   U_NUCMED                      N2PF.                               
      @1034   U_OBSERVATION                 N2PF.                               
      @1036   U_OCCTHERAPY                  N2PF.                               
      @1038   U_ORGANACQ                    N2PF.                               
      @1040   U_OTHIMPLANTS                 N2PF.                               
      @1042   U_PACEMAKER                   N2PF.                               
      @1044   U_PHYTHERAPY                  N2PF.                               
      @1046   U_RADTHERAPY                  N2PF.                               
      @1048   U_RESPTHERAPY                 N2PF.                               
      @1050   U_SPEECHTHERAPY               N2PF.                               
      @1052   U_STRESS                      N2PF.                               
      @1054   U_ULTRASOUND                  N2PF.                               
      ;                                                                         
