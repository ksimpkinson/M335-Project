...
*  Data Step                  *;                                                
*******************************;                                                
DATA HI_SIDC_2011_DX_PR_GRPS;                                                   
INFILE 'HI_SID_2011_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 635;                     
...
INPUT                                                                           
      ...
      @389    INJURY                        N2PF.                               
      @391    INJURY_CUT                    N2PF.                               
      @393    INJURY_DROWN                  N2PF.                               
      @395    INJURY_FALL                   N2PF.                               
      @397    INJURY_FIRE                   N2PF.                               
      @399    INJURY_FIREARM                N2PF.                               
      @401    INJURY_MACHINERY              N2PF.                               
      @403    INJURY_MVT                    N2PF.                               
      @405    INJURY_NATURE                 N2PF.                               
      @407    INJURY_POISON                 N2PF.                               
      @409    INJURY_STRUCK                 N2PF.                               
      @411    INJURY_SUFFOCATION            N2PF.                               
      @413    INTENT_ASSAULT                N2PF.                               
      @415    INTENT_SELF_HARM              N2PF.                               
      @417    INTENT_UNINTENTIONAL          N2PF.                               
      @419    KEY                           15.                                 
      @434    MULTINJURY                    N2PF.                               
      @436    PCLASS1                       N2PF.                               
      @438    PCLASS2                       N2PF.                               
