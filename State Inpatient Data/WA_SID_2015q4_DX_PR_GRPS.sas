...
*  Data Step                  *;                                                
*******************************;                                                
DATA WA_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'WA_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 814;                   
...
INPUT                                                                           
      ...
      @453    I10_ECauseMCCS8               $CHAR11.                            
      @464    I10_ECauseMCCS9               $CHAR11.                            
      @475    I10_ECauseMCCS10              $CHAR11.                            
      @486    I10_INJURY                    N2PF.                               
      @488    I10_MULTINJURY                N2PF.                               
      @490    I10_PCLASS1                   N2PF.                               
      @492    I10_PCLASS2                   N2PF.                               
      @494    I10_PCLASS3                   N2PF.                               
      @496    I10_PCLASS4                   N2PF.                               
      @498    I10_PCLASS5                   N2PF.                               
      @500    I10_PCLASS6                   N2PF.                               
      @502    I10_PCLASS7                   N2PF.                               
      @504    I10_PCLASS8                   N2PF.                               
      @506    I10_PCLASS9                   N2PF.                               
      @508    I10_PCLASS10                  N2PF.                               
      @510    I10_PCLASS11                  N2PF.                               
      @512    I10_PCLASS12                  N2PF.                               
      @514    I10_PCLASS13                  N2PF.                               
      @516    I10_PCLASS14                  N2PF.                               
      @518    I10_PCLASS15                  N2PF.                               
      @520    I10_PCLASS16                  N2PF.                               
      @522    I10_PCLASS17                  N2PF.                               
      @524    I10_PCLASS18                  N2PF.                               
      @526    I10_PCLASS19                  N2PF.                               
      @528    I10_PCLASS20                  N2PF.                               
      @530    I10_PCLASS21                  N2PF.                               
      @532    I10_PCLASS22                  N2PF.                               
      @534    I10_PCLASS23                  N2PF.                               
      @536    I10_PCLASS24                  N2PF.                               
      @538    I10_PCLASS25                  N2PF.                               
      @540    I10_PRMCCS1                   $CHAR8.                             
      @548    I10_PRMCCS2                   $CHAR8.                             
      @556    I10_PRMCCS3                   $CHAR8.                             
      @564    I10_PRMCCS4                   $CHAR8.                             
      @572    I10_PRMCCS5                   $CHAR8.                             
      @580    I10_PRMCCS6                   $CHAR8.                             
      @588    I10_PRMCCS7                   $CHAR8.                             
      @596    I10_PRMCCS8                   $CHAR8.                             
      @604    I10_PRMCCS9                   $CHAR8.                             
      @612    I10_PRMCCS10                  $CHAR8.                             
      @620    I10_PRMCCS11                  $CHAR8.                             
      @628    I10_PRMCCS12                  $CHAR8.                             
      @636    I10_PRMCCS13                  $CHAR8.                             
      @644    I10_PRMCCS14                  $CHAR8.                             
      @652    I10_PRMCCS15                  $CHAR8.                             
      @660    I10_PRMCCS16                  $CHAR8.                             
      @668    I10_PRMCCS17                  $CHAR8.                             
      @676    I10_PRMCCS18                  $CHAR8.                             
      @684    I10_PRMCCS19                  $CHAR8.                             
      @692    I10_PRMCCS20                  $CHAR8.                             
      @700    I10_PRMCCS21                  $CHAR8.                             
      @708    I10_PRMCCS22                  $CHAR8.                             
      @716    I10_PRMCCS23                  $CHAR8.                             
      @724    I10_PRMCCS24                  $CHAR8.                             
      @732    I10_PRMCCS25                  $CHAR8.                             
      @740    I10_U_BLOOD                   N2PF.                               
      @742    I10_U_CATH                    N2PF.                               
      @744    I10_U_CTSCAN                  N2PF.                               
      @746    I10_U_EKG                     N2PF.                               
      @748    I10_U_MHSA                    N2PF.                               
      @750    I10_U_MRT                     N2PF.                               
      @752    I10_U_PACEMAKER               N2PF.                               
      @754    I10_U_PHYTHERAPY              N2PF.                               
      @756    I10_U_RADTHERAPY              N2PF.                               
      @758    I10_U_STRESS                  N2PF.                               
      @760    KEY                           15.                                 
      @775    U_CCU                         N2PF.                               
      @777    U_CHESTXRAY                   N2PF.                               
      @779    U_DIALYSIS                    N2PF.                               
      @781    U_ECHO                        N2PF.                               
      @783    U_ED                          N2PF.                               
      @785    U_EEG                         N2PF.                               
      @787    U_EPO                         N2PF.                               
      @789    U_ICU                         N2PF.                               
      @791    U_LITHOTRIPSY                 N2PF.                               
      @793    U_NEWBN2L                     N2PF.                               
      @795    U_NEWBN3L                     N2PF.                               
      @797    U_NEWBN4L                     N2PF.                               
      @799    U_NUCMED                      N2PF.                               
      @801    U_OBSERVATION                 N2PF.                               
      @803    U_OCCTHERAPY                  N2PF.                               
      @805    U_ORGANACQ                    N2PF.                               
      @807    U_OTHIMPLANTS                 N2PF.                               
      @809    U_RESPTHERAPY                 N2PF.                               
      @811    U_SPEECHTHERAPY               N2PF.                               
      @813    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
