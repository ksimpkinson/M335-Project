...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SIDC_2013_DX_PR_GRPS;                                                   
INFILE 'AR_SID_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 567;                     
...
INPUT                                                                           
      ...
      @381    INJURY                        N2PF.                               
      @383    INJURY_CUT                    N2PF.                               
      @385    INJURY_DROWN                  N2PF.                               
      @387    INJURY_FALL                   N2PF.                               
      @389    INJURY_FIRE                   N2PF.                               
      @391    INJURY_FIREARM                N2PF.                               
      @393    INJURY_MACHINERY              N2PF.                               
      @395    INJURY_MVT                    N2PF.                               
      @397    INJURY_NATURE                 N2PF.                               
      @399    INJURY_POISON                 N2PF.                               
      @401    INJURY_STRUCK                 N2PF.                               
      @403    INJURY_SUFFOCATION            N2PF.                               
      @405    INTENT_ASSAULT                N2PF.                               
      @407    INTENT_SELF_HARM              N2PF.                               
      @409    INTENT_UNINTENTIONAL          N2PF.                               
      @411    KEY                           15.                                 
      @426    MULTINJURY                    N2PF.                               
      @428    PCLASS1                       N2PF.                               
      @430    PCLASS2                       N2PF.                               
      ...
      @542    U_NEWBN4L                     N2PF.                               
      @544    U_NUCMED                      N2PF.                               
      @546    U_OBSERVATION                 N2PF.                               
      @548    U_OCCTHERAPY                  N2PF.                               
      @550    U_ORGANACQ                    N2PF.                               
      @552    U_OTHIMPLANTS                 N2PF.                               
      @554    U_PACEMAKER                   N2PF.                               
      @556    U_PHYTHERAPY                  N2PF.                               
      @558    U_RADTHERAPY                  N2PF.                               
      @560    U_RESPTHERAPY                 N2PF.                               
      @562    U_SPEECHTHERAPY               N2PF.                               
      @564    U_STRESS                      N2PF.                               
      @566    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
