...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SIDC_2006_CORE;                                                         
INFILE 'NV_SID_2006_CORE.ASC' LRECL = 503;                                      
...
INPUT                                                                           
      ...
      @290    HOSPBRTH                 N3PF.                                    
      @293    HOSPST                   $CHAR2.                                  
      @295    INTENSIVECARE            N2PF.                                    
      @297    LOS                      N5PF.                                    
      @302    LOS_X                    N6PF.                                    
      @308    MARITALSTATUS            $CHAR1.                                  
      @309    MDC                      N2PF.                                    
      @311    MDC18                    N2PF.                                    
      @313    MDC24                    N2PF.                                    
      @315    MDNUM1_R                 N9PF.                                    
      ...
      @349    PAY2_X                   $CHAR2.                                  
      @351    PAY3_X                   $CHAR2.                                  
      @353    PL_NHCS2006              N2PF.                                    
      @355    PL_RUCA10_2005           N2PF.                                    
      @357    PL_RUCA2005              N4P1F.                                   
      @361    PL_RUCA4_2005            N2PF.                                    
      @363    PL_RUCC2003              N2PF.                                    
      @365    PL_UIC2003               N2PF.                                    
      @367    PL_UR_CAT4               N2PF.                                    
      @369    PL_UR_CAT5               N2PF.                                    
      @371    PNUM_R                   N9PF.                                    
