...
*  Data Step                  *;                                                
*******************************;                                                
DATA SD_SIDC_2016_CORE;                                                         
INFILE 'SD_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 924;                           
...
INPUT                                                                           
      ...
      @251    I10_DX24                      $CHAR7.                             
      @258    I10_DX25                      $CHAR7.                             
      @265    I10_ECAUSE1                   $CHAR7.                             
      @272    I10_ECAUSE2                   $CHAR7.                             
      @279    I10_ECAUSE3                   $CHAR7.                             
      @286    I10_ECAUSE4                   $CHAR7.                             
      @293    I10_NDX                       N3PF.                               
      @296    I10_NECAUSE                   N2PF.                               
      @298    I10_NPR                       N3PF.                               
      @301    I10_PR1                       $CHAR7.                             
      @308    I10_PR2                       $CHAR7.                             
      @315    I10_PR3                       $CHAR7.                             
      ...
      @571    PointOfOrigin_X               $CHAR1.                             
      @572    PointOfOriginUB04             $CHAR1.                             
      @573    PRDAY1                        N5PF.                               
      @578    PRDAY2                        N5PF.                               
      @583    PRDAY3                        N5PF.                               
      @588    PRDAY4                        N5PF.                               
