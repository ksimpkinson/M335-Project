...
*   OR_SID_2015q1q3_DX_PR_GRPS.SAS:                                             
...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SIDC_2015q1q3_DX_PR_GRPS;                                               
INFILE 'OR_SID_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 995;                 
...
INPUT                                                                           
      ...
      @569    INJURY                        N2PF.                               
      @571    INJURY_CUT                    N2PF.                               
      @573    INJURY_DROWN                  N2PF.                               
      @575    INJURY_FALL                   N2PF.                               
      @577    INJURY_FIRE                   N2PF.                               
      @579    INJURY_FIREARM                N2PF.                               
      @581    INJURY_MACHINERY              N2PF.                               
      @583    INJURY_MVT                    N2PF.                               
      @585    INJURY_NATURE                 N2PF.                               
      @587    INJURY_POISON                 N2PF.                               
      @589    INJURY_STRUCK                 N2PF.                               
      @591    INJURY_SUFFOCATION            N2PF.                               
      @593    INTENT_ASSAULT                N2PF.                               
      @595    INTENT_SELF_HARM              N2PF.                               
      @597    INTENT_UNINTENTIONAL          N2PF.                               
      @599    KEY                           15.                                 
      @614    MULTINJURY                    N2PF.                               
      @616    PCLASS1                       N2PF.                               
      @618    PCLASS2                       N2PF.                               
      ...
      @970    U_NEWBN4L                     N2PF.                               
      @972    U_NUCMED                      N2PF.                               
      @974    U_OBSERVATION                 N2PF.                               
      @976    U_OCCTHERAPY                  N2PF.                               
      @978    U_ORGANACQ                    N2PF.                               
      @980    U_OTHIMPLANTS                 N2PF.                               
      @982    U_PACEMAKER                   N2PF.                               
      @984    U_PHYTHERAPY                  N2PF.                               
      @986    U_RADTHERAPY                  N2PF.                               
      @988    U_RESPTHERAPY                 N2PF.                               
      @990    U_SPEECHTHERAPY               N2PF.                               
      @992    U_STRESS                      N2PF.                               
      @994    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
