...
*  Data Step                  *;                                                
*******************************;                                                
DATA CO_SIDC_2016_CORE;                                                         
INFILE 'CO_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1087;                          
...
INPUT                                                                           
      ...
      @284    I10_DX32                      $CHAR7.                             
      @291    I10_DX33                      $CHAR7.                             
      @298    I10_ECAUSE1                   $CHAR7.                             
      @305    I10_ECAUSE2                   $CHAR7.                             
      @312    I10_ECAUSE3                   $CHAR7.                             
      @319    I10_ECAUSE4                   $CHAR7.                             
      @326    I10_ECAUSE5                   $CHAR7.                             
      @333    I10_ECAUSE6                   $CHAR7.                             
      @340    I10_ECAUSE7                   $CHAR7.                             
      @347    I10_ECAUSE8                   $CHAR7.                             
      @354    I10_ECAUSE9                   $CHAR7.                             
      @361    I10_ECAUSE10                  $CHAR7.                             
      @368    I10_ECAUSE11                  $CHAR7.                             
      @375    I10_ECAUSE12                  $CHAR7.                             
      @382    I10_ECAUSE13                  $CHAR7.                             
      @389    I10_ECAUSE14                  $CHAR7.                             
      @396    I10_NDX                       N3PF.                               
      @399    I10_NECAUSE                   N2PF.                               
      @401    I10_NPR                       N3PF.                               
      @404    I10_PR1                       $CHAR7.                             
      @411    I10_PR2                       $CHAR7.                             
      @418    I10_PR3                       $CHAR7.                             
      ...
      @680    PL_UIC                        N2PF.                               
      @682    PL_UR_CAT4                    N2PF.                               
      @684    PointOfOrigin_X               $CHAR1.                             
      @685    PointOfOriginUB04             $CHAR1.                             
      @686    PRDAY1                        N5PF.                               
      @691    PRDAY2                        N5PF.                               
      @696    PRDAY3                        N5PF.                               
      @701    PRDAY4                        N5PF.                               
