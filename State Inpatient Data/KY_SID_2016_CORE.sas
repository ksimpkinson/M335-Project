...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SIDC_2016_CORE;                                                         
INFILE 'KY_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 976;                           
...
INPUT                                                                           
      ...
      @344    I10_ECAUSE7                   $CHAR7.                             
      @351    I10_NDX                       N3PF.                               
      @354    I10_NECAUSE                   N2PF.                               
      @356    I10_NPR                       N3PF.                               
      @359    I10_PR1                       $CHAR7.                             
      @366    I10_PR2                       $CHAR7.                             
      @373    I10_PR3                       $CHAR7.                             
      ...
      @608    PL_UIC                        N2PF.                               
      @610    PL_UR_CAT4                    N2PF.                               
      @612    POA_Disch_Edit1               N2PF.                               
      @614    POA_Disch_Edit2               N2PF.                               
      @616    POA_Hosp_Edit1                N2PF.                               
      @618    POA_Hosp_Edit2                N2PF.                               
      @620    POA_Hosp_Edit3                N2PF.                               
      @622    POA_Hosp_Edit3_Value          N8P2F.                              
      @630    PointOfOrigin_X               $CHAR1.                             
      @631    PointOfOriginUB04             $CHAR1.                             
      @632    PRDAY1                        N5PF.                               
      @637    PRDAY2                        N5PF.                               
      @642    PRDAY3                        N5PF.                               
      @647    PRDAY4                        N5PF.                               
