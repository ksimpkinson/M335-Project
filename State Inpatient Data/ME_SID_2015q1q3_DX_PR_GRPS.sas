...
*   ME_SID_2015q1q3_DX_PR_GRPS.SAS:                                             
...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SIDC_2015q1q3_DX_PR_GRPS;                                               
INFILE 'ME_SID_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 831;                 
...
INPUT                                                                           
      ...
      @475    INJURY                        N2PF.                               
      @477    INJURY_CUT                    N2PF.                               
      @479    INJURY_DROWN                  N2PF.                               
      @481    INJURY_FALL                   N2PF.                               
      @483    INJURY_FIRE                   N2PF.                               
      @485    INJURY_FIREARM                N2PF.                               
      @487    INJURY_MACHINERY              N2PF.                               
      @489    INJURY_MVT                    N2PF.                               
      @491    INJURY_NATURE                 N2PF.                               
      @493    INJURY_POISON                 N2PF.                               
      @495    INJURY_STRUCK                 N2PF.                               
      @497    INJURY_SUFFOCATION            N2PF.                               
      @499    INTENT_ASSAULT                N2PF.                               
      @501    INTENT_SELF_HARM              N2PF.                               
      @503    INTENT_UNINTENTIONAL          N2PF.                               
      @505    KEY                           15.                                 
      @520    MULTINJURY                    N2PF.                               
      @522    PCLASS1                       N2PF.                               
      @524    PCLASS2                       N2PF.                               
      ...
      @806    U_NEWBN4L                     N2PF.                               
      @808    U_NUCMED                      N2PF.                               
      @810    U_OBSERVATION                 N2PF.                               
      @812    U_OCCTHERAPY                  N2PF.                               
      @814    U_ORGANACQ                    N2PF.                               
      @816    U_OTHIMPLANTS                 N2PF.                               
      @818    U_PACEMAKER                   N2PF.                               
      @820    U_PHYTHERAPY                  N2PF.                               
      @822    U_RADTHERAPY                  N2PF.                               
      @824    U_RESPTHERAPY                 N2PF.                               
      @826    U_SPEECHTHERAPY               N2PF.                               
      @828    U_STRESS                      N2PF.                               
      @830    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
