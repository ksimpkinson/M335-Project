...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SIDC_2011_CORE;                                                         
INFILE 'UT_SID_2011_CORE.ASC' LRECL = 478;                                      
...
INPUT                                                                           
      ...
      @222    HCUP_ED                  N2PF.                                    
      @224    HCUP_OS                  N2PF.                                    
      @226    HCUP_SURGERY_BROAD       N2PF.                                    
      @228    HCUP_SURGERY_NARROW      N2PF.                                    
      @230    HISPANIC_X               $CHAR1.                                  
      @231    HOSPBRTH                 N3PF.                                    
      @234    HOSPST                   $CHAR2.                                  
      @236    Homeless                 N2PF.                                    
      @238    KEY                      15.                                      
      @253    LOS                      N5PF.                                    
      @258    LOS_X                    N6PF.                                    
      @264    MARITALSTATUSUB04        $CHAR1.                                  
      @265    MARITALSTATUS_X          $CHAR1.                                  
      @266    MDC                      N2PF.                                    
      @268    MDC24                    N2PF.                                    
      @270    MDC_NoPOA                N2PF.                                    
      @272    MDNUM1_R                 N9PF.                                    
      ...
      @399    PSTCO                    N5PF.                                    
      @404    PSTCO2                   N5PF.                                    
      @409    PointOfOriginUB04        $CHAR1.                                  
      @410    PointOfOrigin_X          $CHAR1.                                  
      @411    RACE                     N2PF.                                    
      @413    RACE_X                   $CHAR1.                                  
      @414    TOTCHG                   N10PF.                                   
      @424    TOTCHG_X                 N15P2F.                                  
