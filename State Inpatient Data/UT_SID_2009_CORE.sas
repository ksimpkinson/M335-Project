...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SIDC_2009_CORE;                                                         
INFILE 'UT_SID_2009_CORE.ASC' LRECL = 445;                                      
...
INPUT                                                                           
      ...
      @366    PSTCO                    N5PF.                                    
      @371    PSTCO2                   N5PF.                                    
      @376    PointOfOriginUB04        $CHAR1.                                  
      @377    PointOfOrigin_X          $CHAR1.                                  
      @378    RACE                     N2PF.                                    
      @380    RACE_X                   $CHAR1.                                  
      @381    TOTCHG                   N10PF.                                   
      @391    TOTCHG_X                 N15P2F.                                  
