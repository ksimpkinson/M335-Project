...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SIDC_2015q1q3_CORE;                                                     
INFILE 'UT_SID_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1379;                      
...
INPUT                                                                           
      ...
      @1167   PL_RUCC                       N2PF.                               
      @1169   PL_UIC                        N2PF.                               
      @1171   PL_UR_CAT4                    N2PF.                               
      @1173   PointOfOrigin_X               $CHAR1.                             
      @1174   PointOfOriginUB04             $CHAR1.                             
      @1175   PR1                           $CHAR7.                             
      @1182   PR2                           $CHAR7.                             
      @1189   PR3                           $CHAR7.                             
      @1196   PR4                           $CHAR7.                             
