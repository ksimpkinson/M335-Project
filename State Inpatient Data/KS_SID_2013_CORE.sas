...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SIDC_2013_CORE;                                                         
INFILE 'KS_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1250;                          
...
INPUT                                                                           
      ...
      @557    HCUP_ED                       N2PF.                               
      @559    HCUP_OS                       N2PF.                               
      @561    HISPANIC_X                    $CHAR1.                             
      @562    HOSPBRTH                      N3PF.                               
      @565    HOSPST                        $CHAR2.                             
      @567    HospitalUnit                  N2PF.                               
      @569    KEY                           15.                                 
      @584    LOS                           N5PF.                               
      @589    LOS_X                         N6PF.                               
      @595    MDC                           N2PF.                               
      ...
      @633    PL_CBSA                       N3PF.                               
      @636    PL_NCHS                       N2PF.                               
      @638    PL_RUCA10_2005                N2PF.                               
      @640    PL_RUCA2005                   N4P1F.                              
      @644    PL_RUCA4_2005                 N2PF.                               
      @646    PL_RUCC                       N2PF.                               
      @648    PL_UIC                        N2PF.                               
      @650    PL_UR_CAT4                    N2PF.                               
      @652    PR1                           $CHAR7.                             
      ...
      @1032   PSTCO                         N5PF.                               
      @1037   PSTCO2                        N5PF.                               
      @1042   PointOfOriginUB04             $CHAR1.                             
      @1043   PointOfOrigin_X               $CHAR1.                             
      @1044   RACE                          N2PF.                               
      @1046   RACE_X                        $CHAR1.                             
      @1047   TOTCHG                        N10PF.                              
      @1057   TOTCHG_X                      N15P2F.                             
      @1072   TRAN_IN                       N2PF.                               
      @1074   TRAN_OUT                      N2PF.                               
      @1076   YEAR                          N4PF.                               
      @1080   ZIP3                          $CHAR3.                             
      @1083   ZIPINC_QRTL                   N3PF.                               
      @1086   HOSPID                        N5PF.                               
      @1091   AYEAR                         N4PF.                               
      @1095   BMONTH                        N2PF.                               
      @1097   BYEAR                         N4PF.                               
