...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SIDC_2010_CORE;                                                         
INFILE 'NV_SID_2010_CORE.ASC' LRECL = 764;                                      
...
INPUT                                                                           
      ...
      @448    HOSP_NPI                 $CHAR10.                                 
      @458    Homeless                 N2PF.                                    
      @460    INTENSIVECARE            N3PF.                                    
      @463    KEY                      14.                                      
      @477    LOS                      N5PF.                                    
      @482    LOS_X                    N6PF.                                    
      @488    MARITALSTATUSUB04        $CHAR1.                                  
      @489    MARITALSTATUS_X          $CHAR1.                                  
      @490    MDC                      N2PF.                                    
      @492    MDC24                    N2PF.                                    
      @494    MDC_NoPOA                N2PF.                                    
      @496    MDNUM1_R                 N9PF.                                    
      @505    MDNUM2_R                 N9PF.                                    
      @514    MDNUMTYPE1               $CHAR1.                                  
      @515    MDNUMTYPE2               $CHAR1.                                  
      @516    MEDINCSTQ                N2PF.                                    
      @518    NCHRONIC                 N3PF.                                    
      @521    NDX                      N2PF.                                    
      @523    NECODE                   N2PF.                                    
      ...
      @706    PSTCO                    N5PF.                                    
      @711    PSTCO2                   N5PF.                                    
      @716    PointOfOriginUB04        $CHAR1.                                  
      @717    PointOfOrigin_X          $CHAR2.                                  
      @719    RACE                     N2PF.                                    
      @721    RACE_X                   $CHAR2.                                  
      @723    TOTCHG                   N10PF.                                   
      @733    TOTCHG_X                 N15P2F.                                  
