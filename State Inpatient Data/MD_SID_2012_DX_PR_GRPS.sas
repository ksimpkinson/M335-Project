...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SIDC_2012_DX_PR_GRPS;                                                   
INFILE 'MD_SID_2012_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 817;                     
...
INPUT                                                                           
      ...
      @561    INJURY                        N2PF.                               
      @563    INJURY_CUT                    N2PF.                               
      @565    INJURY_DROWN                  N2PF.                               
      @567    INJURY_FALL                   N2PF.                               
      @569    INJURY_FIRE                   N2PF.                               
      @571    INJURY_FIREARM                N2PF.                               
      @573    INJURY_MACHINERY              N2PF.                               
      @575    INJURY_MVT                    N2PF.                               
      @577    INJURY_NATURE                 N2PF.                               
      @579    INJURY_POISON                 N2PF.                               
      @581    INJURY_STRUCK                 N2PF.                               
      @583    INJURY_SUFFOCATION            N2PF.                               
      @585    INTENT_ASSAULT                N2PF.                               
      @587    INTENT_SELF_HARM              N2PF.                               
      @589    INTENT_UNINTENTIONAL          N2PF.                               
      @591    KEY                           15.                                 
      @606    MULTINJURY                    N2PF.                               
      @608    PCLASS1                       N2PF.                               
      @610    PCLASS2                       N2PF.                               
      ...
      @792    U_NEWBN4L                     N2PF.                               
      @794    U_NUCMED                      N2PF.                               
      @796    U_OBSERVATION                 N2PF.                               
      @798    U_OCCTHERAPY                  N2PF.                               
      @800    U_ORGANACQ                    N2PF.                               
      @802    U_OTHIMPLANTS                 N2PF.                               
      @804    U_PACEMAKER                   N2PF.                               
      @806    U_PHYTHERAPY                  N2PF.                               
      @808    U_RADTHERAPY                  N2PF.                               
      @810    U_RESPTHERAPY                 N2PF.                               
      @812    U_SPEECHTHERAPY               N2PF.                               
      @814    U_STRESS                      N2PF.                               
      @816    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
