...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'SC_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 522;                   
...
INPUT                                                                           
      ...
      @57     I10_CHRON14                   N2PF.                               
      @59     I10_CHRON15                   N2PF.                               
      @61     I10_DXMCCS1                   $CHAR11.                            
      @72     I10_DXMCCS2                   $CHAR11.                            
      @83     I10_DXMCCS3                   $CHAR11.                            
      @94     I10_DXMCCS4                   $CHAR11.                            
      @105    I10_DXMCCS5                   $CHAR11.                            
      @116    I10_DXMCCS6                   $CHAR11.                            
      @127    I10_DXMCCS7                   $CHAR11.                            
      @138    I10_DXMCCS8                   $CHAR11.                            
      @149    I10_DXMCCS9                   $CHAR11.                            
      @160    I10_DXMCCS10                  $CHAR11.                            
      @171    I10_DXMCCS11                  $CHAR11.                            
      @182    I10_DXMCCS12                  $CHAR11.                            
      @193    I10_DXMCCS13                  $CHAR11.                            
      @204    I10_DXMCCS14                  $CHAR11.                            
      @215    I10_DXMCCS15                  $CHAR11.                            
      @226    I10_ECauseMCCS1               $CHAR11.                            
      @237    I10_ECauseMCCS2               $CHAR11.                            
      @248    I10_ECauseMCCS3               $CHAR11.                            
      @259    I10_ECauseMCCS4               $CHAR11.                            
      @270    I10_ECauseMCCS5               $CHAR11.                            
      @281    I10_ECauseMCCS6               $CHAR11.                            
      @292    I10_ECauseMCCS7               $CHAR11.                            
      @303    I10_ECauseMCCS8               $CHAR11.                            
      @314    I10_INJURY                    N2PF.                               
      @316    I10_MULTINJURY                N2PF.                               
      @318    I10_PCLASS1                   N2PF.                               
      @320    I10_PCLASS2                   N2PF.                               
      @322    I10_PCLASS3                   N2PF.                               
      @324    I10_PCLASS4                   N2PF.                               
      @326    I10_PCLASS5                   N2PF.                               
      @328    I10_PCLASS6                   N2PF.                               
      @330    I10_PCLASS7                   N2PF.                               
      @332    I10_PCLASS8                   N2PF.                               
      @334    I10_PCLASS9                   N2PF.                               
      @336    I10_PCLASS10                  N2PF.                               
      @338    I10_PCLASS11                  N2PF.                               
      @340    I10_PCLASS12                  N2PF.                               
      @342    I10_PCLASS13                  N2PF.                               
      @344    I10_PRMCCS1                   $CHAR8.                             
      @352    I10_PRMCCS2                   $CHAR8.                             
      @360    I10_PRMCCS3                   $CHAR8.                             
      @368    I10_PRMCCS4                   $CHAR8.                             
      @376    I10_PRMCCS5                   $CHAR8.                             
      @384    I10_PRMCCS6                   $CHAR8.                             
      @392    I10_PRMCCS7                   $CHAR8.                             
      @400    I10_PRMCCS8                   $CHAR8.                             
      @408    I10_PRMCCS9                   $CHAR8.                             
      @416    I10_PRMCCS10                  $CHAR8.                             
      @424    I10_PRMCCS11                  $CHAR8.                             
      @432    I10_PRMCCS12                  $CHAR8.                             
      @440    I10_PRMCCS13                  $CHAR8.                             
      @448    I10_U_BLOOD                   N2PF.                               
      @450    I10_U_CATH                    N2PF.                               
      @452    I10_U_CTSCAN                  N2PF.                               
      @454    I10_U_EKG                     N2PF.                               
      @456    I10_U_MHSA                    N2PF.                               
      @458    I10_U_MRT                     N2PF.                               
      @460    I10_U_PACEMAKER               N2PF.                               
      @462    I10_U_PHYTHERAPY              N2PF.                               
      @464    I10_U_RADTHERAPY              N2PF.                               
      @466    I10_U_STRESS                  N2PF.                               
      @468    KEY                           15.                                 
      @483    U_CCU                         N2PF.                               
      @485    U_CHESTXRAY                   N2PF.                               
      @487    U_DIALYSIS                    N2PF.                               
      @489    U_ECHO                        N2PF.                               
      @491    U_ED                          N2PF.                               
      @493    U_EEG                         N2PF.                               
      @495    U_EPO                         N2PF.                               
      @497    U_ICU                         N2PF.                               
      @499    U_LITHOTRIPSY                 N2PF.                               
      @501    U_NEWBN2L                     N2PF.                               
      @503    U_NEWBN3L                     N2PF.                               
      @505    U_NEWBN4L                     N2PF.                               
      @507    U_NUCMED                      N2PF.                               
      @509    U_OBSERVATION                 N2PF.                               
      @511    U_OCCTHERAPY                  N2PF.                               
      @513    U_ORGANACQ                    N2PF.                               
      @515    U_OTHIMPLANTS                 N2PF.                               
      @517    U_RESPTHERAPY                 N2PF.                               
      @519    U_SPEECHTHERAPY               N2PF.                               
      @521    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
