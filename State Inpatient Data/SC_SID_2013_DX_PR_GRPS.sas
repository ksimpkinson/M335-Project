...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2013_DX_PR_GRPS;                                                   
INFILE 'SC_SID_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 512;                     
...
INPUT                                                                           
      ...
      @336    INJURY                        N2PF.                               
      @338    INJURY_CUT                    N2PF.                               
      @340    INJURY_DROWN                  N2PF.                               
      @342    INJURY_FALL                   N2PF.                               
      @344    INJURY_FIRE                   N2PF.                               
      @346    INJURY_FIREARM                N2PF.                               
      @348    INJURY_MACHINERY              N2PF.                               
      @350    INJURY_MVT                    N2PF.                               
      @352    INJURY_NATURE                 N2PF.                               
      @354    INJURY_POISON                 N2PF.                               
      @356    INJURY_STRUCK                 N2PF.                               
      @358    INJURY_SUFFOCATION            N2PF.                               
      @360    INTENT_ASSAULT                N2PF.                               
      @362    INTENT_SELF_HARM              N2PF.                               
      @364    INTENT_UNINTENTIONAL          N2PF.                               
      @366    KEY                           15.                                 
      @381    MULTINJURY                    N2PF.                               
      @383    PCLASS1                       N2PF.                               
      @385    PCLASS2                       N2PF.                               
