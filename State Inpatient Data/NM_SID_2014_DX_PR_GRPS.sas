...
*  Data Step                  *;                                                
*******************************;                                                
DATA NM_SIDC_2014_DX_PR_GRPS;                                                   
INFILE 'NM_SID_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 558;                     
...
INPUT                                                                           
      ...
      @392    INJURY                        N2PF.                               
      @394    INJURY_CUT                    N2PF.                               
      @396    INJURY_DROWN                  N2PF.                               
      @398    INJURY_FALL                   N2PF.                               
      @400    INJURY_FIRE                   N2PF.                               
      @402    INJURY_FIREARM                N2PF.                               
      @404    INJURY_MACHINERY              N2PF.                               
      @406    INJURY_MVT                    N2PF.                               
      @408    INJURY_NATURE                 N2PF.                               
      @410    INJURY_POISON                 N2PF.                               
      @412    INJURY_STRUCK                 N2PF.                               
      @414    INJURY_SUFFOCATION            N2PF.                               
      @416    INTENT_ASSAULT                N2PF.                               
      @418    INTENT_SELF_HARM              N2PF.                               
      @420    INTENT_UNINTENTIONAL          N2PF.                               
      @422    KEY                           15.                                 
      @437    MULTINJURY                    N2PF.                               
      @439    PCLASS1                       N2PF.                               
      @441    PCLASS2                       N2PF.                               
      ...
      @533    U_NEWBN4L                     N2PF.                               
      @535    U_NUCMED                      N2PF.                               
      @537    U_OBSERVATION                 N2PF.                               
      @539    U_OCCTHERAPY                  N2PF.                               
      @541    U_ORGANACQ                    N2PF.                               
      @543    U_OTHIMPLANTS                 N2PF.                               
      @545    U_PACEMAKER                   N2PF.                               
      @547    U_PHYTHERAPY                  N2PF.                               
      @549    U_RADTHERAPY                  N2PF.                               
      @551    U_RESPTHERAPY                 N2PF.                               
      @553    U_SPEECHTHERAPY               N2PF.                               
      @555    U_STRESS                      N2PF.                               
      @557    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
