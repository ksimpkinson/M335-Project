...
*  Data Step                  *;                                                
*******************************;                                                
DATA FL_SIDC_2010_CORE;                                                         
INFILE 'FL_SID_2010_CORE.ASC' LRECL = 1094;                                     
...
INPUT                                                                           
      ...
      @406    HCUP_ED                  N2PF.                                    
      @408    HCUP_OS                  N2PF.                                    
      @410    HISPANIC_X               $CHAR8.                                  
      @418    HOSPBRTH                 N3PF.                                    
      @421    HOSPST                   $CHAR2.                                  
      @423    Homeless                 N2PF.                                    
      @425    HospitalUnit             N2PF.                                    
      @427    KEY                      18.                                      
      @445    LOS                      N5PF.                                    
      @450    LOS_X                    N6PF.                                    
      @456    MDC                      N2PF.                                    
      ...
      @507    PL_CBSA                  N3PF.                                    
      @510    PL_MSA1993               N3PF.                                    
      @513    PL_NCHS2006              N2PF.                                    
      @515    PL_RUCA10_2005           N2PF.                                    
      @517    PL_RUCA2005              N4P1F.                                   
      @521    PL_RUCA4_2005            N2PF.                                    
      @523    PL_RUCC2003              N2PF.                                    
      @525    PL_UIC2003               N2PF.                                    
      @527    PL_UR_CAT4               N2PF.                                    
      @529    PR1                      $CHAR4.                                  
      @533    PR2                      $CHAR4.                                  
