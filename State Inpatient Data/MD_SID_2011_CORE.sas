...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SIDC_2011_CORE;                                                         
INFILE 'MD_SID_2011_CORE.ASC' FIRSTOBS=3 LRECL = 984;                           
...
INPUT                                                                           
      ...
      @570    HCUP_ED                       N2PF.                               
      @572    HCUP_OS                       N2PF.                               
      @574    HCUP_SURGERY_BROAD            N2PF.                               
      @576    HCUP_SURGERY_NARROW           N2PF.                               
      @578    HISPANIC_X                    $CHAR1.                             
      @579    HOSPBRTH                      N3PF.                               
      @582    HOSPST                        $CHAR2.                             
      @584    HospitalUnit                  N2PF.                               
      @586    KEY                           15.                                 
      @601    LOS                           N5PF.                               
      @606    LOS_X                         N6PF.                               
      @612    MARITALSTATUSUB04             $CHAR1.                             
      @613    MARITALSTATUS_X               $CHAR1.                             
      @614    MDC                           N2PF.                               
      @616    MDC24                         N2PF.                               
      @618    MDC_NoPOA                     N2PF.                               
      @620    MDNUM1_R                      N9PF.                               
      ...
      @689    PL_CBSA                       N3PF.                               
      @692    PL_MSA1993                    N3PF.                               
      @695    PL_NCHS2006                   N2PF.                               
      @697    PL_RUCA10_2005                N2PF.                               
      @699    PL_RUCA2005                   N4P1F.                              
      @703    PL_RUCA4_2005                 N2PF.                               
      @705    PL_RUCC2003                   N2PF.                               
      @707    PL_UIC2003                    N2PF.                               
      @709    PL_UR_CAT4                    N2PF.                               
      @711    PR1                           $CHAR7.                             
      @718    PR2                           $CHAR7.                             
