...
*   VT_SID_2015q1q3_DX_PR_GRPS.SAS:                                             
...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SIDC_2015q1q3_DX_PR_GRPS;                                               
INFILE 'VT_SID_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 717;                 
...
INPUT                                                                           
      ...
      @411    INJURY                        N2PF.                               
      @413    INJURY_CUT                    N2PF.                               
      @415    INJURY_DROWN                  N2PF.                               
      @417    INJURY_FALL                   N2PF.                               
      @419    INJURY_FIRE                   N2PF.                               
      @421    INJURY_FIREARM                N2PF.                               
      @423    INJURY_MACHINERY              N2PF.                               
      @425    INJURY_MVT                    N2PF.                               
      @427    INJURY_NATURE                 N2PF.                               
      @429    INJURY_POISON                 N2PF.                               
      @431    INJURY_STRUCK                 N2PF.                               
      @433    INJURY_SUFFOCATION            N2PF.                               
      @435    INTENT_ASSAULT                N2PF.                               
      @437    INTENT_SELF_HARM              N2PF.                               
      @439    INTENT_UNINTENTIONAL          N2PF.                               
      @441    KEY                           15.                                 
      @456    MULTINJURY                    N2PF.                               
      @458    PCLASS1                       N2PF.                               
      @460    PCLASS2                       N2PF.                               
      ...
      @692    U_NEWBN4L                     N2PF.                               
      @694    U_NUCMED                      N2PF.                               
      @696    U_OBSERVATION                 N2PF.                               
      @698    U_OCCTHERAPY                  N2PF.                               
      @700    U_ORGANACQ                    N2PF.                               
      @702    U_OTHIMPLANTS                 N2PF.                               
      @704    U_PACEMAKER                   N2PF.                               
      @706    U_PHYTHERAPY                  N2PF.                               
      @708    U_RADTHERAPY                  N2PF.                               
      @710    U_RESPTHERAPY                 N2PF.                               
      @712    U_SPEECHTHERAPY               N2PF.                               
      @714    U_STRESS                      N2PF.                               
      @716    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
