...
*  Data Step                  *;                                                
*******************************;                                                
DATA SD_SIDC_2009_CORE;                                                         
INFILE 'SD_SID_2009_CORE.ASC' LRECL = 2261;                                     
...
INPUT                                                                           
      ...
      @986    PL_CBSA                  N3PF.                                    
      @989    PL_MSA1993               N3PF.                                    
      @992    PL_NCHS2006              N2PF.                                    
      @994    PL_RUCA10_2005           N2PF.                                    
      @996    PL_RUCA2005              N4P1F.                                   
      @1000   PL_RUCA4_2005            N2PF.                                    
      @1002   PL_RUCC2003              N2PF.                                    
      @1004   PL_UIC2003               N2PF.                                    
      @1006   PL_UR_CAT4               N2PF.                                    
      @1008   PR1                      $CHAR4.                                  
      @1012   PR2                      $CHAR4.                                  
      @1016   PR3                      $CHAR4.                                  
      @1020   PR4                      $CHAR4.                                  
      ...
      @1793   PSTCO                    N5PF.                                    
      @1798   PSTCO2                   N5PF.                                    
      @1803   PointOfOriginUB04        $CHAR1.                                  
      @1804   PointOfOrigin_X          $CHAR1.                                  
      @1805   RACE                     N2PF.                                    
      @1807   RACE_X                   $CHAR4.                                  
      @1811   TOTCHG                   N10PF.                                   
      @1821   TOTCHG_X                 N15P2F.                                  
      @1836   TRAN_IN                  N2PF.                                    
      @1838   TRAN_OUT                 N2PF.                                    
      @1840   YEAR                     N4PF.                                    
      @1844   ZIP3                     $CHAR3.                                  
      @1847   ZIPINC_QRTL              N3PF.                                    
      @1850   HOSPID                   N5PF.                                    
      @1855   ZIP                      $CHAR5.                                  
      @1860   AYEAR                    N4PF.                                    
      @1864   DMONTH                   N2PF.                                    
