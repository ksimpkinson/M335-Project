...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SIDC_2012_DX_PR_GRPS;                                                   
INFILE 'NE_SID_2012_DX_PR_GRPS.ASC' LRECL = 357;                                
...
INPUT                                                                           
      ...
      @191    INJURY                   N2PF.                                    
      @193    INJURY_CUT               N2PF.                                    
      @195    INJURY_DROWN             N2PF.                                    
      @197    INJURY_FALL              N2PF.                                    
      @199    INJURY_FIRE              N2PF.                                    
      @201    INJURY_FIREARM           N2PF.                                    
      @203    INJURY_MACHINERY         N2PF.                                    
      @205    INJURY_MVT               N2PF.                                    
      @207    INJURY_NATURE            N2PF.                                    
      @209    INJURY_POISON            N2PF.                                    
      @211    INJURY_STRUCK            N2PF.                                    
      @213    INJURY_SUFFOCATION       N2PF.                                    
      @215    INTENT_ASSAULT           N2PF.                                    
      @217    INTENT_SELF_HARM         N2PF.                                    
      @219    INTENT_UNINTENTIONAL     N2PF.                                    
      @221    KEY                      15.                                      
      @236    MULTINJURY               N2PF.                                    
      @238    PCLASS1                  N2PF.                                    
      @240    PCLASS2                  N2PF.                                    
      ...
      @332    U_NEWBN4L                N2PF.                                    
      @334    U_NUCMED                 N2PF.                                    
      @336    U_OBSERVATION            N2PF.                                    
      @338    U_OCCTHERAPY             N2PF.                                    
      @340    U_ORGANACQ               N2PF.                                    
      @342    U_OTHIMPLANTS            N2PF.                                    
      @344    U_PACEMAKER              N2PF.                                    
      @346    U_PHYTHERAPY             N2PF.                                    
      @348    U_RADTHERAPY             N2PF.                                    
      @350    U_RESPTHERAPY            N2PF.                                    
      @352    U_SPEECHTHERAPY          N2PF.                                    
      @354    U_STRESS                 N2PF.                                    
      @356    U_ULTRASOUND             N2PF.                                    
      ;                                                                         
