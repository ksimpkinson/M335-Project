...
*  Data Step                  *;                                                
*******************************;                                                
DATA MS_SIDC_2014_DX_PR_GRPS;                                                   
INFILE 'MS_SID_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 1030;                    
...
INPUT                                                                           
      ...
      @674    INJURY                        N2PF.                               
      @676    INJURY_CUT                    N2PF.                               
      @678    INJURY_DROWN                  N2PF.                               
      @680    INJURY_FALL                   N2PF.                               
      @682    INJURY_FIRE                   N2PF.                               
      @684    INJURY_FIREARM                N2PF.                               
      @686    INJURY_MACHINERY              N2PF.                               
      @688    INJURY_MVT                    N2PF.                               
      @690    INJURY_NATURE                 N2PF.                               
      @692    INJURY_POISON                 N2PF.                               
      @694    INJURY_STRUCK                 N2PF.                               
      @696    INJURY_SUFFOCATION            N2PF.                               
      @698    INTENT_ASSAULT                N2PF.                               
      @700    INTENT_SELF_HARM              N2PF.                               
      @702    INTENT_UNINTENTIONAL          N2PF.                               
      @704    KEY                           15.                                 
      @719    MULTINJURY                    N2PF.                               
      @721    PCLASS1                       N2PF.                               
      @723    PCLASS2                       N2PF.                               
      ...
      @1005   U_NEWBN4L                     N2PF.                               
      @1007   U_NUCMED                      N2PF.                               
      @1009   U_OBSERVATION                 N2PF.                               
      @1011   U_OCCTHERAPY                  N2PF.                               
      @1013   U_ORGANACQ                    N2PF.                               
      @1015   U_OTHIMPLANTS                 N2PF.                               
      @1017   U_PACEMAKER                   N2PF.                               
      @1019   U_PHYTHERAPY                  N2PF.                               
      @1021   U_RADTHERAPY                  N2PF.                               
      @1023   U_RESPTHERAPY                 N2PF.                               
      @1025   U_SPEECHTHERAPY               N2PF.                               
      @1027   U_STRESS                      N2PF.                               
      @1029   U_ULTRASOUND                  N2PF.                               
      ;                                                                         
