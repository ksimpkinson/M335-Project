...
INFILE 'MD_SID_2012_CORE.ASC' FIRSTOBS=3 LRECL = 1004;                          
...
INPUT                                                                           
      ...
      @576    HCUP_ED                       N2PF.                               
      @578    HCUP_OS                       N2PF.                               
      @580    HISPANIC_X                    $CHAR1.                             
      @581    HOSPBRTH                      N3PF.                               
      @584    HOSPST                        $CHAR2.                             
      @586    HospitalUnit                  N2PF.                               
      @588    KEY                           15.                                 
      @603    LOS                           N5PF.                               
      @608    LOS_X                         N6PF.                               
      @614    MARITALSTATUSUB04             $CHAR1.                             
      @615    MARITALSTATUS_X               $CHAR1.                             
      @616    MDC                           N2PF.                               
      @618    MDC24                         N2PF.                               
      @620    MDC_NoPOA                     N2PF.                               
      @622    MDNUM1_R                      N9PF.                               
      ...
      @691    PL_CBSA                       N3PF.                               
      @694    PL_MSA1993                    N3PF.                               
      @697    PL_NCHS2006                   N2PF.                               
      @699    PL_RUCA10_2005                N2PF.                               
      @701    PL_RUCA2005                   N4P1F.                              
      @705    PL_RUCA4_2005                 N2PF.                               
      @707    PL_RUCC2003                   N2PF.                               
      @709    PL_UIC2003                    N2PF.                               
      @711    PL_UR_CAT4                    N2PF.                               
      @713    PNUM_R                        N9PF.                               
      @722    PR1                           $CHAR7.                             
