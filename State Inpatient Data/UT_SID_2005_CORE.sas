...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SIDC_2005_CORE;                                                         
INFILE 'UT_SID_2005_CORE.ASC' LRECL = 382;                                      
...
INPUT                                                                           
      ...
      @209    HCUP_ED                  N2PF.                                    
      @211    HCUP_OS                  N2PF.                                    
      @213    HISPANIC_X               $CHAR1.                                  
      @214    HOSPST                   $CHAR2.                                  
      @216    LOS                      N5PF.                                    
      @221    LOS_X                    N6PF.                                    
      @227    MEDINCSTQ                N2PF.                                    
      @229    MARITALSTATUS            $CHAR1.                                  
      @230    MDC                      N2PF.                                    
      @232    MDC18                    N2PF.                                    
      @234    MDSPEC1                  $CHAR7.                                  
      @241    MDSPEC2                  $CHAR7.                                  
      ...
      @266    PL_CBSA                  N3PF.                                    
      @269    PL_MSA1993               N3PF.                                    
      @272    PL_NHCS2006              N2PF.                                    
      @274    PL_RUCA10_2005           N2PF.                                    
      @276    PL_RUCA2005              N4P1F.                                   
      @280    PL_RUCA4_2005            N2PF.                                    
      @282    PL_RUCC2003              N2PF.                                    
      @284    PL_UIC2003               N2PF.                                    
      @286    PL_UR_CAT4               N2PF.                                    
      @288    PL_UR_CAT5               N2PF.                                    
      @290    PR1                      $CHAR4.                                  
