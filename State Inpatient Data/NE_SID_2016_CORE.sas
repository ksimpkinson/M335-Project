...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SIDC_2016_CORE;                                                         
INFILE 'NE_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 804;                           
...
INPUT                                                                           
      ...
      @271    I10_DX24                      $CHAR7.                             
      @278    I10_DX25                      $CHAR7.                             
      @285    I10_ECAUSE1                   $CHAR7.                             
      @292    I10_ECAUSE2                   $CHAR7.                             
      @299    I10_ECAUSE3                   $CHAR7.                             
      @306    I10_ECAUSE4                   $CHAR7.                             
      @313    I10_ECAUSE5                   $CHAR7.                             
      @320    I10_ECAUSE6                   $CHAR7.                             
      @327    I10_ECAUSE7                   $CHAR7.                             
      @334    I10_NDX                       N3PF.                               
      @337    I10_NECAUSE                   N2PF.                               
      @339    I10_NPR                       N3PF.                               
      @342    I10_PR1                       $CHAR7.                             
      @349    I10_PR2                       $CHAR7.                             
      @356    I10_PR3                       $CHAR7.                             
      ...
      @433    I10_PR14                      $CHAR7.                             
      @440    I10_PR15                      $CHAR7.                             
      @447    I10_PROCTYPE                  N3PF.                               
      @450    KEY                           15.                                 
      @465    LOS                           N5PF.                               
      @470    LOS_X                         N6PF.                               
      @476    MARITALSTATUS_X               $CHAR1.                             
      @477    MARITALSTATUSUB04             $CHAR1.                             
      @478    MDC                           N2PF.                               
      @480    MDC_NoPOA                     N2PF.                               
      @482    MEDINCSTQ                     N2PF.                               
      @484    OS_TIME                       N11P2F.                             
      ...
      @516    PL_UIC                        N2PF.                               
      @518    PL_UR_CAT4                    N2PF.                               
      @520    POA_Disch_Edit1               N2PF.                               
      @522    POA_Disch_Edit2               N2PF.                               
      @524    POA_Hosp_Edit1                N2PF.                               
      @526    POA_Hosp_Edit2                N2PF.                               
      @528    POA_Hosp_Edit3                N2PF.                               
      @530    POA_Hosp_Edit3_Value          N8P2F.                              
      @538    PointOfOrigin_X               $CHAR1.                             
      @539    PointOfOriginUB04             $CHAR1.                             
      @540    PRDAY1                        N5PF.                               
      @545    PRDAY2                        N5PF.                               
      @550    PRDAY3                        N5PF.                               
      @555    PRDAY4                        N5PF.                               
