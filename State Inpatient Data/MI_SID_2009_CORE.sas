...
*  Data Step                  *;                                                
*******************************;                                                
DATA MI_SIDC_2009_CORE;                                                         
INFILE 'MI_SID_2009_CORE.ASC' LRECL = 1189;                                     
...
INPUT                                                                           
      ...
      @552    PL_CBSA                  N3PF.                                    
      @555    PL_MSA1993               N3PF.                                    
      @558    PL_NCHS2006              N2PF.                                    
      @560    PL_RUCA10_2005           N2PF.                                    
      @562    PL_RUCA2005              N4P1F.                                   
      @566    PL_RUCA4_2005            N2PF.                                    
      @568    PL_RUCC2003              N2PF.                                    
      @570    PL_UIC2003               N2PF.                                    
      @572    PL_UR_CAT4               N2PF.                                    
      @574    PR1                      $CHAR4.                                  
      @578    PR2                      $CHAR4.                                  
      ...
      @937    PSTATE                   $CHAR2.                                  
      @939    PSTCO2                   N5PF.                                    
      @944    PointOfOriginUB04        $CHAR1.                                  
      @945    PointOfOrigin_X          $CHAR1.                                  
      @946    RACE                     N2PF.                                    
      @948    RACE_X                   $CHAR1.                                  
      @949    TOTCHG                   N10PF.                                   
      @959    TOTCHG_X                 N15P2F.                                  
