...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SIDC_2010_CORE;                                                         
INFILE 'NJ_SID_2010_CORE.ASC' LRECL = 1435;                                     
...
INPUT                                                                           
      ...
      @762    HCUP_ED                  N2PF.                                    
      @764    HCUP_OS                  N2PF.                                    
      @766    HISPANIC_X               $CHAR5.                                  
      @771    HOSPBRTH                 N3PF.                                    
      @774    HOSPST                   $CHAR2.                                  
      @776    KEY                      18.                                      
      @794    LOS                      N5PF.                                    
      @799    LOS_X                    N6PF.                                    
      @805    MARITALSTATUSUB04        $CHAR1.                                  
      @806    MDC                      N2PF.                                    
      @808    MDC24                    N2PF.                                    
      @810    MDC_NoPOA                N2PF.                                    
      @812    MDNUM1_R                 N9PF.                                    
      ...
      @883    PL_CBSA                  N3PF.                                    
      @886    PL_MSA1993               N3PF.                                    
      @889    PL_NCHS2006              N2PF.                                    
      @891    PL_RUCA10_2005           N2PF.                                    
      @893    PL_RUCA2005              N4P1F.                                   
      @897    PL_RUCA4_2005            N2PF.                                    
      @899    PL_RUCC2003              N2PF.                                    
      @901    PL_UIC2003               N2PF.                                    
      @903    PL_UR_CAT4               N2PF.                                    
      @905    PR1                      $CHAR4.                                  
      @909    PR2                      $CHAR4.                                  
      ...
      @1210   PSTCO                    N5PF.                                    
      @1215   PSTCO2                   N5PF.                                    
      @1220   PointOfOriginUB04        $CHAR1.                                  
      @1221   PointOfOrigin_X          $CHAR1.                                  
      @1222   PrimLang                 $CHAR3.                                  
      @1225   RACE                     N2PF.                                    
      @1227   RACE_X                   $CHAR5.                                  
      @1232   READMIT                  N2PF.                                    
      @1234   TOTCHG                   N10PF.                                   
      @1244   TOTCHG_X                 N15P2F.                                  
      @1259   TRAN_IN                  N2PF.                                    
      @1261   TRAN_OUT                 N2PF.                                    
      @1263   YEAR                     N4PF.                                    
      @1267   ZIP3                     $CHAR3.                                  
      @1270   ZIPINC_QRTL              N3PF.                                    
      @1273   TOWN                     $CHAR4.                                  
      @1277   ZIP                      $CHAR5.                                  
      @1282   AYEAR                    N4PF.                                    
      @1286   BMONTH                   N2PF.                                    
