...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SIDC_2014_DX_PR_GRPS;                                                   
INFILE 'MD_SID_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 945;                     
...
INPUT                                                                           
      ...
      @539    INJURY                        N2PF.                               
      @541    INJURY_CUT                    N2PF.                               
      @543    INJURY_DROWN                  N2PF.                               
      @545    INJURY_FALL                   N2PF.                               
      @547    INJURY_FIRE                   N2PF.                               
      @549    INJURY_FIREARM                N2PF.                               
      @551    INJURY_MACHINERY              N2PF.                               
      @553    INJURY_MVT                    N2PF.                               
      @555    INJURY_NATURE                 N2PF.                               
      @557    INJURY_POISON                 N2PF.                               
      @559    INJURY_STRUCK                 N2PF.                               
      @561    INJURY_SUFFOCATION            N2PF.                               
      @563    INTENT_ASSAULT                N2PF.                               
      @565    INTENT_SELF_HARM              N2PF.                               
      @567    INTENT_UNINTENTIONAL          N2PF.                               
      @569    KEY                           15.                                 
      @584    MULTINJURY                    N2PF.                               
      @586    PCLASS1                       N2PF.                               
      @588    PCLASS2                       N2PF.                               
      ...
      @920    U_NEWBN4L                     N2PF.                               
      @922    U_NUCMED                      N2PF.                               
      @924    U_OBSERVATION                 N2PF.                               
      @926    U_OCCTHERAPY                  N2PF.                               
      @928    U_ORGANACQ                    N2PF.                               
      @930    U_OTHIMPLANTS                 N2PF.                               
      @932    U_PACEMAKER                   N2PF.                               
      @934    U_PHYTHERAPY                  N2PF.                               
      @936    U_RADTHERAPY                  N2PF.                               
      @938    U_RESPTHERAPY                 N2PF.                               
      @940    U_SPEECHTHERAPY               N2PF.                               
      @942    U_STRESS                      N2PF.                               
      @944    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
