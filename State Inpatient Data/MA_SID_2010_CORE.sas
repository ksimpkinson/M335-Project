...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SIDC_2010_CORE;                                                         
INFILE 'MA_SID_2010_CORE.ASC' LRECL = 758;                                      
...
INPUT                                                                           
      ...
      @400    PL_CBSA                  N3PF.                                    
      @403    PL_MSA1993               N3PF.                                    
      @406    PL_RUCA10_2005           N2PF.                                    
      @408    PL_RUCA2005              N4P1F.                                   
      @412    PL_RUCA4_2005            N2PF.                                    
      @414    PL_UR_CAT4               N2PF.                                    
      @416    PR1                      $CHAR4.                                  
      @420    PR2                      $CHAR4.                                  
      @424    PR3                      $CHAR4.                                  
      ...
      @599    PSTATE                   $CHAR2.                                  
      @601    PSTCO2                   N5PF.                                    
      @606    PointOfOriginUB04        $CHAR1.                                  
      @607    PointOfOrigin_X          $CHAR1.                                  
      @608    RACE                     N2PF.                                    
      @610    RACE_X                   $CHAR5.                                  
      @615    TOTCHG                   N10PF.                                   
      @625    TOTCHG_X                 N15P2F.                                  
