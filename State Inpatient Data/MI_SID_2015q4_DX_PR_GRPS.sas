...
*  Data Step                  *;                                                
*******************************;                                                
DATA MI_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'MI_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 879;                   
...
INPUT                                                                           
      ...
      @561    I10_INJURY                    N2PF.                               
      @563    I10_MULTINJURY                N2PF.                               
      @565    I10_PCLASS1                   N2PF.                               
      @567    I10_PCLASS2                   N2PF.                               
      @569    I10_PCLASS3                   N2PF.                               
      @571    I10_PCLASS4                   N2PF.                               
      @573    I10_PCLASS5                   N2PF.                               
      @575    I10_PCLASS6                   N2PF.                               
      @577    I10_PCLASS7                   N2PF.                               
      @579    I10_PCLASS8                   N2PF.                               
      @581    I10_PCLASS9                   N2PF.                               
      @583    I10_PCLASS10                  N2PF.                               
      @585    I10_PCLASS11                  N2PF.                               
      @587    I10_PCLASS12                  N2PF.                               
      @589    I10_PCLASS13                  N2PF.                               
      @591    I10_PCLASS14                  N2PF.                               
      @593    I10_PCLASS15                  N2PF.                               
      @595    I10_PCLASS16                  N2PF.                               
      @597    I10_PCLASS17                  N2PF.                               
      @599    I10_PCLASS18                  N2PF.                               
      @601    I10_PCLASS19                  N2PF.                               
      @603    I10_PCLASS20                  N2PF.                               
      @605    I10_PCLASS21                  N2PF.                               
      @607    I10_PCLASS22                  N2PF.                               
      @609    I10_PCLASS23                  N2PF.                               
      @611    I10_PCLASS24                  N2PF.                               
      @613    I10_PCLASS25                  N2PF.                               
      @615    I10_PCLASS26                  N2PF.                               
      @617    I10_PCLASS27                  N2PF.                               
      @619    I10_PCLASS28                  N2PF.                               
      @621    I10_PCLASS29                  N2PF.                               
      @623    I10_PCLASS30                  N2PF.                               
      @625    I10_PRMCCS1                   $CHAR8.                             
      @633    I10_PRMCCS2                   $CHAR8.                             
      @641    I10_PRMCCS3                   $CHAR8.                             
      @649    I10_PRMCCS4                   $CHAR8.                             
      @657    I10_PRMCCS5                   $CHAR8.                             
      @665    I10_PRMCCS6                   $CHAR8.                             
      @673    I10_PRMCCS7                   $CHAR8.                             
      @681    I10_PRMCCS8                   $CHAR8.                             
      @689    I10_PRMCCS9                   $CHAR8.                             
      @697    I10_PRMCCS10                  $CHAR8.                             
      @705    I10_PRMCCS11                  $CHAR8.                             
      @713    I10_PRMCCS12                  $CHAR8.                             
      @721    I10_PRMCCS13                  $CHAR8.                             
      @729    I10_PRMCCS14                  $CHAR8.                             
      @737    I10_PRMCCS15                  $CHAR8.                             
      @745    I10_PRMCCS16                  $CHAR8.                             
      @753    I10_PRMCCS17                  $CHAR8.                             
      @761    I10_PRMCCS18                  $CHAR8.                             
      @769    I10_PRMCCS19                  $CHAR8.                             
      @777    I10_PRMCCS20                  $CHAR8.                             
      @785    I10_PRMCCS21                  $CHAR8.                             
      @793    I10_PRMCCS22                  $CHAR8.                             
      @801    I10_PRMCCS23                  $CHAR8.                             
      @809    I10_PRMCCS24                  $CHAR8.                             
      @817    I10_PRMCCS25                  $CHAR8.                             
      @825    I10_PRMCCS26                  $CHAR8.                             
      @833    I10_PRMCCS27                  $CHAR8.                             
      @841    I10_PRMCCS28                  $CHAR8.                             
      @849    I10_PRMCCS29                  $CHAR8.                             
      @857    I10_PRMCCS30                  $CHAR8.                             
      @865    KEY                           15.                                 
      ;                                                                         
