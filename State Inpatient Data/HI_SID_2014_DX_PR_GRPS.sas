...
*  Data Step                  *;                                                
*******************************;                                                
DATA HI_SIDC_2014_DX_PR_GRPS;                                                   
INFILE 'HI_SID_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 820;                     
...
INPUT                                                                           
      ...
      @464    INJURY                        N2PF.                               
      @466    INJURY_CUT                    N2PF.                               
      @468    INJURY_DROWN                  N2PF.                               
      @470    INJURY_FALL                   N2PF.                               
      @472    INJURY_FIRE                   N2PF.                               
      @474    INJURY_FIREARM                N2PF.                               
      @476    INJURY_MACHINERY              N2PF.                               
      @478    INJURY_MVT                    N2PF.                               
      @480    INJURY_NATURE                 N2PF.                               
      @482    INJURY_POISON                 N2PF.                               
      @484    INJURY_STRUCK                 N2PF.                               
      @486    INJURY_SUFFOCATION            N2PF.                               
      @488    INTENT_ASSAULT                N2PF.                               
      @490    INTENT_SELF_HARM              N2PF.                               
      @492    INTENT_UNINTENTIONAL          N2PF.                               
      @494    KEY                           15.                                 
      @509    MULTINJURY                    N2PF.                               
      @511    PCLASS1                       N2PF.                               
      @513    PCLASS2                       N2PF.                               
      ...
      @795    U_NEWBN4L                     N2PF.                               
      @797    U_NUCMED                      N2PF.                               
      @799    U_OBSERVATION                 N2PF.                               
      @801    U_OCCTHERAPY                  N2PF.                               
      @803    U_ORGANACQ                    N2PF.                               
      @805    U_OTHIMPLANTS                 N2PF.                               
      @807    U_PACEMAKER                   N2PF.                               
      @809    U_PHYTHERAPY                  N2PF.                               
      @811    U_RADTHERAPY                  N2PF.                               
      @813    U_RESPTHERAPY                 N2PF.                               
      @815    U_SPEECHTHERAPY               N2PF.                               
      @817    U_STRESS                      N2PF.                               
      @819    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
