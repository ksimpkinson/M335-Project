...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SIDC_2007_CORE;                                                         
INFILE 'ME_SID_2007_CORE.ASC' LRECL = 400;                                      
...
INPUT                                                                           
      ...
      @234    PL_CBSA                  N3PF.                                    
      @237    PL_MSA1993               N3PF.                                    
      @240    PL_NCHS2006              N2PF.                                    
      @242    PL_RUCA4_2005            N2PF.                                    
      @244    PL_UIC2003               N2PF.                                    
      @246    PL_UR_CAT4               N2PF.                                    
      @248    PR1                      $CHAR4.                                  
      @252    PR2                      $CHAR4.                                  
      ...
      @325    PSTCO                    N5PF.                                    
      @330    PSTCO2                   N5PF.                                    
      @335    PointOfOriginUB04        $CHAR1.                                  
      @336    YEAR                     N4PF.                                    
      @340    ZIP3                     $CHAR3.                                  
      @343    ZIPINC_QRTL              N3PF.                                    
      @346    ZIP_S                    $CHAR5.                                  
      @351    AGEGROUP                 N3PF.                                    
      @354    HOSPID                   N5PF.                                    
      @359    AYEAR                    N4PF.                                    
