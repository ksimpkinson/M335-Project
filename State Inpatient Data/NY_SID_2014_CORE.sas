...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SIDC_2014_CORE;                                                         
INFILE 'NY_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1027;                          
...
INPUT                                                                           
      ...
      @380    DXPOA25                       $CHAR1.                             
      @381    DXVER                         N3PF.                               
      @384    DX_Admitting                  $CHAR7.                             
      @391    DaysToEvent                   N6PF.                               
      @397    ECODE1                        $CHAR7.                             
      @404    ECODE2                        $CHAR7.                             
      @411    ECODE3                        $CHAR7.                             
      @418    ECODE4                        $CHAR7.                             
      ...
      @623    PL_UIC                        N2PF.                               
      @625    PL_UR_CAT4                    N2PF.                               
      @627    POA_Disch_Edit1               N2PF.                               
      @629    POA_Disch_Edit2               N2PF.                               
      @631    POA_Hosp_Edit1                N2PF.                               
      @633    POA_Hosp_Edit2                N2PF.                               
      @635    POA_Hosp_Edit3                N2PF.                               
      @637    POA_Hosp_Edit3_Value          N8P2F.                              
      @645    PR1                           $CHAR7.                             
      @652    PR2                           $CHAR7.                             
      @659    PR3                           $CHAR7.                             
      @666    PR4                           $CHAR7.                             
      ...
      @863    PSTCO                         N5PF.                               
      @868    PSTCO2                        N5PF.                               
      @873    PointOfOriginUB04             $CHAR1.                             
      @874    PointOfOrigin_X               $CHAR1.                             
      @875    RACE                          N2PF.                               
      @877    RACE_X                        $CHAR2.                             
      @879    SERVICELINE                   N2PF.                               
      @881    TOTCHG                        N10PF.                              
      @891    TOTCHG_X                      N15P2F.                             
      @906    TRAN_IN                       N2PF.                               
      @908    TRAN_OUT                      N2PF.                               
