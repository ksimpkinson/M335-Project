...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SIDC_2011_CORE;                                                         
INFILE 'AR_SID_2011_CORE.ASC' FIRSTOBS=3 LRECL = 787;                           
...
INPUT                                                                           
      ...
      @390    HCUP_ED                       N2PF.                               
      @392    HCUP_OS                       N2PF.                               
      @394    HCUP_SURGERY_BROAD            N2PF.                               
      @396    HCUP_SURGERY_NARROW           N2PF.                               
      @398    HISPANIC_X                    $CHAR1.                             
      @399    HOSPBRTH                      N3PF.                               
      @402    HOSPST                        $CHAR2.                             
      @404    KEY                           15.                                 
      @419    LOS                           N5PF.                               
      @424    LOS_X                         N6PF.                               
      @430    MARITALSTATUSUB04             $CHAR1.                             
      @431    MARITALSTATUS_X               $CHAR1.                             
      @432    MDC                           N2PF.                               
      @434    MDC24                         N2PF.                               
      @436    MDC_NoPOA                     N2PF.                               
      @438    MDNUM1_R                      N9PF.                               
      ...
      @675    PSTATE                        $CHAR2.                             
      @677    PSTCO2                        N5PF.                               
      @682    PointOfOriginUB04             $CHAR1.                             
      @683    PointOfOrigin_X               $CHAR1.                             
      @684    RACE                          N2PF.                               
      @686    RACE_X                        $CHAR1.                             
      @687    TOTCHG                        N10PF.                              
      @697    TOTCHG_X                      N15P2F.                             
