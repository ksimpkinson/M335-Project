...
*  Data Step                  *;                                                
*******************************;                                                
DATA WA_SIDC_2014_CORE;                                                         
INFILE 'WA_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1104;                          
...
INPUT                                                                           
      ...
      @497    HCUP_ED                       N2PF.                               
      @499    HCUP_OS                       N2PF.                               
      @501    HISPANIC_X                    $CHAR1.                             
      @502    HOSPBRTH                      N3PF.                               
      @505    HOSPST                        $CHAR2.                             
      @507    Homeless                      N2PF.                               
      @509    HospitalUnit                  N2PF.                               
      @511    KEY                           15.                                 
      @526    LOS                           N5PF.                               
      @531    LOS_X                         N6PF.                               
      @537    MDC                           N2PF.                               
      ...
      @626    PL_UIC                        N2PF.                               
      @628    PL_UR_CAT4                    N2PF.                               
      @630    POA_Disch_Edit1               N2PF.                               
      @632    POA_Disch_Edit2               N2PF.                               
      @634    POA_Hosp_Edit1                N2PF.                               
      @636    POA_Hosp_Edit2                N2PF.                               
      @638    POA_Hosp_Edit3                N2PF.                               
      @640    POA_Hosp_Edit3_Value          N8P2F.                              
      @648    PR1                           $CHAR7.                             
      @655    PR2                           $CHAR7.                             
      @662    PR3                           $CHAR7.                             
      @669    PR4                           $CHAR7.                             
      ...
      @1029   PSTATE                        $CHAR2.                             
      @1031   PSTCO2                        N5PF.                               
      @1036   PointOfOriginUB04             $CHAR1.                             
      @1037   PointOfOrigin_X               $CHAR1.                             
      @1038   RACE                          N2PF.                               
      @1040   RACE_X                        $CHAR6.                             
      @1046   SERVICELINE                   N2PF.                               
      @1048   TOTCHG                        N10PF.                              
      @1058   TOTCHG_X                      N15P2F.                             
      @1073   TRAN_IN                       N2PF.                               
      @1075   TRAN_OUT                      N2PF.                               
      @1077   VisitLink                     N9PF.                               
      @1086   YEAR                          N4PF.                               
