...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'KS_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 900;                   
...
INPUT                                                                           
      ...
      @572    I10_INJURY                    N2PF.                               
      @574    I10_MULTINJURY                N2PF.                               
      @576    I10_PCLASS1                   N2PF.                               
      @578    I10_PCLASS2                   N2PF.                               
      @580    I10_PCLASS3                   N2PF.                               
      @582    I10_PCLASS4                   N2PF.                               
      @584    I10_PCLASS5                   N2PF.                               
      @586    I10_PCLASS6                   N2PF.                               
      @588    I10_PCLASS7                   N2PF.                               
      @590    I10_PCLASS8                   N2PF.                               
      @592    I10_PCLASS9                   N2PF.                               
      @594    I10_PCLASS10                  N2PF.                               
      @596    I10_PCLASS11                  N2PF.                               
      @598    I10_PCLASS12                  N2PF.                               
      @600    I10_PCLASS13                  N2PF.                               
      @602    I10_PCLASS14                  N2PF.                               
      @604    I10_PCLASS15                  N2PF.                               
      @606    I10_PCLASS16                  N2PF.                               
      @608    I10_PCLASS17                  N2PF.                               
      @610    I10_PCLASS18                  N2PF.                               
      @612    I10_PCLASS19                  N2PF.                               
      @614    I10_PCLASS20                  N2PF.                               
      @616    I10_PCLASS21                  N2PF.                               
      @618    I10_PCLASS22                  N2PF.                               
      @620    I10_PCLASS23                  N2PF.                               
      @622    I10_PCLASS24                  N2PF.                               
      @624    I10_PCLASS25                  N2PF.                               
      @626    I10_PRMCCS1                   $CHAR8.                             
      @634    I10_PRMCCS2                   $CHAR8.                             
      @642    I10_PRMCCS3                   $CHAR8.                             
      @650    I10_PRMCCS4                   $CHAR8.                             
      @658    I10_PRMCCS5                   $CHAR8.                             
      @666    I10_PRMCCS6                   $CHAR8.                             
      @674    I10_PRMCCS7                   $CHAR8.                             
      @682    I10_PRMCCS8                   $CHAR8.                             
      @690    I10_PRMCCS9                   $CHAR8.                             
      @698    I10_PRMCCS10                  $CHAR8.                             
      @706    I10_PRMCCS11                  $CHAR8.                             
      @714    I10_PRMCCS12                  $CHAR8.                             
      @722    I10_PRMCCS13                  $CHAR8.                             
      @730    I10_PRMCCS14                  $CHAR8.                             
      @738    I10_PRMCCS15                  $CHAR8.                             
      @746    I10_PRMCCS16                  $CHAR8.                             
      @754    I10_PRMCCS17                  $CHAR8.                             
      @762    I10_PRMCCS18                  $CHAR8.                             
      @770    I10_PRMCCS19                  $CHAR8.                             
      @778    I10_PRMCCS20                  $CHAR8.                             
      @786    I10_PRMCCS21                  $CHAR8.                             
      @794    I10_PRMCCS22                  $CHAR8.                             
      @802    I10_PRMCCS23                  $CHAR8.                             
      @810    I10_PRMCCS24                  $CHAR8.                             
      @818    I10_PRMCCS25                  $CHAR8.                             
      @826    I10_U_BLOOD                   N2PF.                               
      @828    I10_U_CATH                    N2PF.                               
      @830    I10_U_CTSCAN                  N2PF.                               
      @832    I10_U_EKG                     N2PF.                               
      @834    I10_U_MHSA                    N2PF.                               
      @836    I10_U_MRT                     N2PF.                               
      @838    I10_U_PACEMAKER               N2PF.                               
      @840    I10_U_PHYTHERAPY              N2PF.                               
      @842    I10_U_RADTHERAPY              N2PF.                               
      @844    I10_U_STRESS                  N2PF.                               
      @846    KEY                           15.                                 
      @861    U_CCU                         N2PF.                               
      @863    U_CHESTXRAY                   N2PF.                               
      @865    U_DIALYSIS                    N2PF.                               
      @867    U_ECHO                        N2PF.                               
      @869    U_ED                          N2PF.                               
      @871    U_EEG                         N2PF.                               
      @873    U_EPO                         N2PF.                               
      @875    U_ICU                         N2PF.                               
      @877    U_LITHOTRIPSY                 N2PF.                               
      @879    U_NEWBN2L                     N2PF.                               
      @881    U_NEWBN3L                     N2PF.                               
      @883    U_NEWBN4L                     N2PF.                               
      @885    U_NUCMED                      N2PF.                               
      @887    U_OBSERVATION                 N2PF.                               
      @889    U_OCCTHERAPY                  N2PF.                               
      @891    U_ORGANACQ                    N2PF.                               
      @893    U_OTHIMPLANTS                 N2PF.                               
      @895    U_RESPTHERAPY                 N2PF.                               
      @897    U_SPEECHTHERAPY               N2PF.                               
      @899    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
