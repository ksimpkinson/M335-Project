...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'AR_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 915;                   
...
ATTRIB                                                                          
  ...
  I10_ECauseMCCS15           LENGTH=$11                                         
  LABEL="ICD-10-CM Multi-Level CCS:  E Cause 15"                                
                                                                                
  I10_ECauseMCCS16           LENGTH=$11                                         
  LABEL="ICD-10-CM Multi-Level CCS:  E Cause 16"                                
...
INPUT                                                                           
      ...
      @605    I10_ECauseMCCS15              $CHAR11.                            
      @616    I10_ECauseMCCS16              $CHAR11.                            
      @627    I10_INJURY                    N2PF.                               
      @629    I10_MULTINJURY                N2PF.                               
      @631    I10_PCLASS1                   N2PF.                               
      @633    I10_PCLASS2                   N2PF.                               
      @635    I10_PCLASS3                   N2PF.                               
      @637    I10_PCLASS4                   N2PF.                               
      @639    I10_PCLASS5                   N2PF.                               
      @641    I10_PCLASS6                   N2PF.                               
      @643    I10_PCLASS7                   N2PF.                               
      @645    I10_PCLASS8                   N2PF.                               
      @647    I10_PCLASS9                   N2PF.                               
      @649    I10_PCLASS10                  N2PF.                               
      @651    I10_PCLASS11                  N2PF.                               
      @653    I10_PCLASS12                  N2PF.                               
      @655    I10_PCLASS13                  N2PF.                               
      @657    I10_PCLASS14                  N2PF.                               
      @659    I10_PCLASS15                  N2PF.                               
      @661    I10_PCLASS16                  N2PF.                               
      @663    I10_PCLASS17                  N2PF.                               
      @665    I10_PCLASS18                  N2PF.                               
      @667    I10_PCLASS19                  N2PF.                               
      @669    I10_PCLASS20                  N2PF.                               
      @671    I10_PCLASS21                  N2PF.                               
      @673    I10_PRMCCS1                   $CHAR8.                             
      @681    I10_PRMCCS2                   $CHAR8.                             
      @689    I10_PRMCCS3                   $CHAR8.                             
      @697    I10_PRMCCS4                   $CHAR8.                             
      @705    I10_PRMCCS5                   $CHAR8.                             
      @713    I10_PRMCCS6                   $CHAR8.                             
      @721    I10_PRMCCS7                   $CHAR8.                             
      @729    I10_PRMCCS8                   $CHAR8.                             
      @737    I10_PRMCCS9                   $CHAR8.                             
      @745    I10_PRMCCS10                  $CHAR8.                             
      @753    I10_PRMCCS11                  $CHAR8.                             
      @761    I10_PRMCCS12                  $CHAR8.                             
      @769    I10_PRMCCS13                  $CHAR8.                             
      @777    I10_PRMCCS14                  $CHAR8.                             
      @785    I10_PRMCCS15                  $CHAR8.                             
      @793    I10_PRMCCS16                  $CHAR8.                             
      @801    I10_PRMCCS17                  $CHAR8.                             
      @809    I10_PRMCCS18                  $CHAR8.                             
      @817    I10_PRMCCS19                  $CHAR8.                             
      @825    I10_PRMCCS20                  $CHAR8.                             
      @833    I10_PRMCCS21                  $CHAR8.                             
      @841    I10_U_BLOOD                   N2PF.                               
      @843    I10_U_CATH                    N2PF.                               
      @845    I10_U_CTSCAN                  N2PF.                               
      @847    I10_U_EKG                     N2PF.                               
      @849    I10_U_MHSA                    N2PF.                               
      @851    I10_U_MRT                     N2PF.                               
      @853    I10_U_PACEMAKER               N2PF.                               
      @855    I10_U_PHYTHERAPY              N2PF.                               
      @857    I10_U_RADTHERAPY              N2PF.                               
      @859    I10_U_STRESS                  N2PF.                               
      @861    KEY                           15.                                 
      @876    U_CCU                         N2PF.                               
      @878    U_CHESTXRAY                   N2PF.                               
      @880    U_DIALYSIS                    N2PF.                               
      @882    U_ECHO                        N2PF.                               
      @884    U_ED                          N2PF.                               
      @886    U_EEG                         N2PF.                               
      @888    U_EPO                         N2PF.                               
      @890    U_ICU                         N2PF.                               
      @892    U_LITHOTRIPSY                 N2PF.                               
      @894    U_NEWBN2L                     N2PF.                               
      @896    U_NEWBN3L                     N2PF.                               
      @898    U_NEWBN4L                     N2PF.                               
      @900    U_NUCMED                      N2PF.                               
      @902    U_OBSERVATION                 N2PF.                               
      @904    U_OCCTHERAPY                  N2PF.                               
      @906    U_ORGANACQ                    N2PF.                               
      @908    U_OTHIMPLANTS                 N2PF.                               
      @910    U_RESPTHERAPY                 N2PF.                               
      @912    U_SPEECHTHERAPY               N2PF.                               
      @914    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
