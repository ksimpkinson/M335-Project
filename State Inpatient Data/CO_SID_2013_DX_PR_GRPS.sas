...
*  Data Step                  *;                                                
*******************************;                                                
DATA CO_SIDC_2013_DX_PR_GRPS;                                                   
INFILE 'CO_SID_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 940;                     
...
INPUT                                                                           
      ...
      @594    INJURY                   N2PF.                                    
      @596    INJURY_CUT               N2PF.                                    
      @598    INJURY_DROWN             N2PF.                                    
      @600    INJURY_FALL              N2PF.                                    
      @602    INJURY_FIRE              N2PF.                                    
      @604    INJURY_FIREARM           N2PF.                                    
      @606    INJURY_MACHINERY         N2PF.                                    
      @608    INJURY_MVT               N2PF.                                    
      @610    INJURY_NATURE            N2PF.                                    
      @612    INJURY_POISON            N2PF.                                    
      @614    INJURY_STRUCK            N2PF.                                    
      @616    INJURY_SUFFOCATION       N2PF.                                    
      @618    INTENT_ASSAULT           N2PF.                                    
      @620    INTENT_SELF_HARM         N2PF.                                    
      @622    INTENT_UNINTENTIONAL     N2PF.                                    
      @624    KEY                      15.                                      
      @639    MULTINJURY               N2PF.                                    
      @641    PCLASS1                  N2PF.                                    
      @643    PCLASS2                  N2PF.                                    
