...
*  Data Step                  *;                                                
*******************************;                                                
DATA WA_SIDC_2009_CORE;                                                         
INFILE 'WA_SID_2009_CORE.ASC' LRECL = 918;                                      
...
INPUT                                                                           
      ...
      @310    DXPOA24                  $CHAR1.                                  
      @311    DXPOA25                  $CHAR1.                                  
      @312    DaysBetweenVisits        N4PF.                                    
      @316    DaysToEvent              N6PF.                                    
      @322    ECODE1                   $CHAR5.                                  
      @327    ECODE2                   $CHAR5.                                  
      @332    ECODE3                   $CHAR5.                                  
      @337    ECODE4                   $CHAR5.                                  
      ...
      @404    HCUP_ED                  N2PF.                                    
      @406    HCUP_OS                  N2PF.                                    
      @408    HISPANIC_X               $CHAR1.                                  
      @409    HOSPBRTH                 N3PF.                                    
      @412    HOSPST                   $CHAR2.                                  
      @414    HospitalUnit             N2PF.                                    
      @416    KEY                      14.                                      
      @430    LOS                      N5PF.                                    
      @435    LOS_X                    N6PF.                                    
      @441    MDC                      N2PF.                                    
      ...
      @845    PSTATE                   $CHAR2.                                  
      @847    PSTCO2                   N5PF.                                    
      @852    PointOfOriginUB04        $CHAR1.                                  
      @853    PointOfOrigin_X          $CHAR1.                                  
      @854    RACE                     N2PF.                                    
      @856    RACE_X                   $CHAR6.                                  
      @862    TOTCHG                   N10PF.                                   
      @872    TOTCHG_X                 N15P2F.                                  
