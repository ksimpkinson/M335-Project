...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2009_CORE;                                                         
INFILE 'SC_SID_2009_CORE.ASC' FIRSTOBS=3 LRECL = 633;                           
...
INPUT                                                                           
      ...
      @583    PSTATE                        $CHAR2.                             
      @585    PSTCO                         N5PF.                               
      @590    PointOfOriginUB04             $CHAR1.                             
      @591    PointOfOrigin_X               $CHAR1.                             
      @592    RACE                          N2PF.                               
      @594    RACE_X                        $CHAR1.                             
      @595    TOTCHG                        N10PF.                              
      @605    TOTCHG_X                      N15P2F.                             
