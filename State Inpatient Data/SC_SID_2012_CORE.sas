...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2012_CORE;                                                         
INFILE 'SC_SID_2012_CORE.ASC' FIRSTOBS=3 LRECL = 640;                           
...
INPUT                                                                           
      ...
      @380    PAY1                          N2PF.                               
      @382    PAY1_X                        $CHAR2.                             
      @384    PL_NCHS2006                   N2PF.                               
      @386    PL_RUCA10_2005                N2PF.                               
      @388    PL_RUCA4_2005                 N2PF.                               
      @390    PL_UR_CAT4                    N2PF.                               
      @392    PR1                           $CHAR7.                             
      @399    PR2                           $CHAR7.                             
      @406    PR3                           $CHAR7.                             
      ...
      @590    PSTATE                        $CHAR2.                             
      @592    PSTCO                         N5PF.                               
      @597    PointOfOriginUB04             $CHAR1.                             
      @598    PointOfOrigin_X               $CHAR1.                             
      @599    RACE                          N2PF.                               
      @601    RACE_X                        $CHAR1.                             
      @602    TOTCHG                        N10PF.                              
      @612    TOTCHG_X                      N15P2F.                             
