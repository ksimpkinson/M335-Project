...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SIDC_2011_CORE;                                                         
INFILE 'AZ_SID_2011_CORE.ASC' LRECL = 807;                                      
...
INPUT                                                                           
      ...
      @380    HCUP_ED                  N2PF.                                    
      @382    HCUP_OS                  N2PF.                                    
      @384    HCUP_SURGERY_BROAD       N2PF.                                    
      @386    HCUP_SURGERY_NARROW      N2PF.                                    
      @388    HOSPBRTH                 N3PF.                                    
      @391    HOSPST                   $CHAR2.                                  
      @393    HOSP_NPI                 $CHAR10.                                 
      @403    Homeless                 N2PF.                                    
      ...
      @500    PL_CBSA                  N3PF.                                    
      @503    PL_MSA1993               N3PF.                                    
      @506    PL_NCHS2006              N2PF.                                    
      @508    PL_RUCA10_2005           N2PF.                                    
      @510    PL_RUCA2005              N4P1F.                                   
      @514    PL_RUCA4_2005            N2PF.                                    
      @516    PL_RUCC2003              N2PF.                                    
      @518    PL_UIC2003               N2PF.                                    
      @520    PL_UR_CAT4               N2PF.                                    
      @522    PR1                      $CHAR4.                                  
      @526    PR2                      $CHAR4.                                  
      ...
      @669    PSTATE                   $CHAR2.                                  
      @671    PSTCO2                   N5PF.                                    
      @676    PointOfOriginUB04        $CHAR1.                                  
      @677    PointOfOrigin_X          $CHAR1.                                  
      @678    RACE                     N2PF.                                    
      @680    RACE_X                   $CHAR4.                                  
      @684    SPLIT_IPED               N2PF.                                    
      @686    TOTCHG                   N10PF.                                   
