...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2014_CORE;                                                         
INFILE 'SC_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 679;                           
...
INPUT                                                                           
      ...
      @400    PL_NCHS                       N2PF.                               
      @402    PL_UR_CAT4                    N2PF.                               
      @404    POA_Disch_Edit1               N2PF.                               
      @406    POA_Disch_Edit2               N2PF.                               
      @408    POA_Hosp_Edit1                N2PF.                               
      @410    POA_Hosp_Edit2                N2PF.                               
      @412    POA_Hosp_Edit3                N2PF.                               
      @414    POA_Hosp_Edit3_Value          N8P2F.                              
      @422    PR1                           $CHAR7.                             
      @429    PR2                           $CHAR7.                             
      @436    PR3                           $CHAR7.                             
      @443    PR4                           $CHAR7.                             
