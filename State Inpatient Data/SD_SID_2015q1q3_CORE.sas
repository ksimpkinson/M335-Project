...
*  Data Step                  *;                                                
*******************************;                                                
DATA SD_SIDC_2015q1q3_CORE;                                                     
INFILE 'SD_SID_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1144;                      
...
INPUT                                                                           
      ...
      @514    PL_UIC                        N2PF.                               
      @516    PL_UR_CAT4                    N2PF.                               
      @518    POA_Disch_Edit1               N2PF.                               
      @520    POA_Disch_Edit2               N2PF.                               
      @522    POA_Hosp_Edit1                N2PF.                               
      @524    POA_Hosp_Edit2                N2PF.                               
      @526    POA_Hosp_Edit3                N2PF.                               
      @528    POA_Hosp_Edit3_Value          N8P2F.                              
      @536    PointOfOrigin_X               $CHAR1.                             
      @537    PointOfOriginUB04             $CHAR1.                             
      @538    PR1                           $CHAR7.                             
      @545    PR2                           $CHAR7.                             
      @552    PR3                           $CHAR7.                             
      @559    PR4                           $CHAR7.                             
