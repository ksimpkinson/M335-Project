...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SIDC_2014_CORE;                                                         
INFILE 'MD_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1215;                          
...
INPUT                                                                           
      ...
      @417    DXPOA30                       $CHAR1.                             
      @418    DXVER                         N3PF.                               
      @421    DaysBurnUnit                  N3PF.                               
      @424    DaysCCU                       N3PF.                               
      @427    DaysICU                       N3PF.                               
      @430    DaysNICU                      N3PF.                               
      @433    DaysPICU                      N3PF.                               
      @436    DaysShockUnit                 N3PF.                               
      @439    DaysToEvent                   N6PF.                               
      @445    ECODE1                        $CHAR7.                             
      @452    ECODE2                        $CHAR7.                             
      @459    ECODE3                        $CHAR7.                             
      @466    ECODE4                        $CHAR7.                             
      ...
      @543    HCUP_ED                       N2PF.                               
      @545    HCUP_OS                       N2PF.                               
      @547    HISPANIC_X                    $CHAR1.                             
      @548    HOSPBRTH                      N3PF.                               
      @551    HOSPST                        $CHAR2.                             
      @553    Homeless                      N2PF.                               
      @555    HospitalUnit                  N2PF.                               
      @557    KEY                           15.                                 
      @572    LOS                           N5PF.                               
      @577    LOS_X                         N6PF.                               
      @583    MARITALSTATUSUB04             $CHAR1.                             
      @584    MARITALSTATUS_X               $CHAR1.                             
      @585    MDC                           N2PF.                               
      @587    MDC24                         N2PF.                               
      @589    MDC_NoPOA                     N2PF.                               
      @591    MDNUM1_R                      N9PF.                               
      ...
      @664    PL_UIC                        N2PF.                               
      @666    PL_UR_CAT4                    N2PF.                               
      @668    POA_Disch_Edit1               N2PF.                               
      @670    POA_Disch_Edit2               N2PF.                               
      @672    POA_Hosp_Edit1                N2PF.                               
      @674    POA_Hosp_Edit2                N2PF.                               
      @676    POA_Hosp_Edit3                N2PF.                               
      @678    POA_Hosp_Edit3_Value          N8P2F.                              
      @686    PR1                           $CHAR7.                             
      @693    PR2                           $CHAR7.                             
      @700    PR3                           $CHAR7.                             
      @707    PR4                           $CHAR7.                             
