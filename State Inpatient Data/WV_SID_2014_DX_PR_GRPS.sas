...
*  Data Step                  *;                                                
*******************************;                                                
DATA WV_SIDC_2014_DX_PR_GRPS;                                                   
INFILE 'WV_SID_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 503;                     
...
INPUT                                                                           
      ...
      @337    INJURY                        N2PF.                               
      @339    INJURY_CUT                    N2PF.                               
      @341    INJURY_DROWN                  N2PF.                               
      @343    INJURY_FALL                   N2PF.                               
      @345    INJURY_FIRE                   N2PF.                               
      @347    INJURY_FIREARM                N2PF.                               
      @349    INJURY_MACHINERY              N2PF.                               
      @351    INJURY_MVT                    N2PF.                               
      @353    INJURY_NATURE                 N2PF.                               
      @355    INJURY_POISON                 N2PF.                               
      @357    INJURY_STRUCK                 N2PF.                               
      @359    INJURY_SUFFOCATION            N2PF.                               
      @361    INTENT_ASSAULT                N2PF.                               
      @363    INTENT_SELF_HARM              N2PF.                               
      @365    INTENT_UNINTENTIONAL          N2PF.                               
      @367    KEY                           15.                                 
      @382    MULTINJURY                    N2PF.                               
      @384    PCLASS1                       N2PF.                               
      @386    PCLASS2                       N2PF.                               
      ...
      @478    U_NEWBN4L                     N2PF.                               
      @480    U_NUCMED                      N2PF.                               
      @482    U_OBSERVATION                 N2PF.                               
      @484    U_OCCTHERAPY                  N2PF.                               
      @486    U_ORGANACQ                    N2PF.                               
      @488    U_OTHIMPLANTS                 N2PF.                               
      @490    U_PACEMAKER                   N2PF.                               
      @492    U_PHYTHERAPY                  N2PF.                               
      @494    U_RADTHERAPY                  N2PF.                               
      @496    U_RESPTHERAPY                 N2PF.                               
      @498    U_SPEECHTHERAPY               N2PF.                               
      @500    U_STRESS                      N2PF.                               
      @502    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
