...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SIDC_2015q1q3_CORE;                                                     
INFILE 'VT_SID_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1846;                      
...
INPUT                                                                           
      ...
      @1198   HCUP_OS                       N2PF.                               
      @1200   HISPANIC                      N2PF.                               
      @1202   HISPANIC_X                    $CHAR1.                             
      @1203   HOSP_NPI                      $CHAR10.                            
      @1213   HOSPBRTH                      N3PF.                               
      @1216   HOSPST                        $CHAR2.                             
      @1218   KEY                           15.                                 
      @1233   LOS                           N5PF.                               
      ...
      @1309   PL_RUCC                       N2PF.                               
      @1311   PL_UIC                        N2PF.                               
      @1313   PL_UR_CAT4                    N2PF.                               
      @1315   POA_Disch_Edit1               N2PF.                               
      @1317   POA_Disch_Edit2               N2PF.                               
      @1319   POA_Hosp_Edit1                N2PF.                               
      @1321   POA_Hosp_Edit2                N2PF.                               
      @1323   POA_Hosp_Edit3                N2PF.                               
      @1325   POA_Hosp_Edit3_Value          N8P2F.                              
      @1333   PointOfOrigin_X               $CHAR1.                             
      @1334   PointOfOriginUB04             $CHAR1.                             
      @1335   PR1                           $CHAR7.                             
      @1342   PR2                           $CHAR7.                             
      @1349   PR3                           $CHAR7.                             
      @1356   PR4                           $CHAR7.                             
