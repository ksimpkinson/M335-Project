...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SIDC_2012_CORE;                                                         
INFILE 'RI_SID_2012_CORE.ASC' FIRSTOBS=3 LRECL = 1191;                          
...
INPUT                                                                           
      ...
      @625    NEOMAT                   N2PF.                                    
      @627    NPR                      N2PF.                                    
      @629    OBSERVATION              N4PF.                                    
      @633    ORPROC                   N2PF.                                    
      @635    PAY1                     N2PF.                                    
      @637    PAY1_X                   $CHAR7.                                  
      @644    PL_CBSA                  N3PF.                                    
      @647    PL_MSA1993               N3PF.                                    
      @650    PL_NCHS2006              N2PF.                                    
      @652    PL_RUCA10_2005           N2PF.                                    
      @654    PL_RUCA2005              N4P1F.                                   
      @658    PL_RUCA4_2005            N2PF.                                    
      @660    PL_RUCC2003              N2PF.                                    
      @662    PL_UIC2003               N2PF.                                    
      @664    PL_UR_CAT4               N2PF.                                    
      @666    PR1                      $CHAR4.                                  
      @670    PR2                      $CHAR4.                                  
      ...
      @982    PointOfOrigin_X          $CHAR1.                                  
      @983    RACE                     N2PF.                                    
      @985    RACE_X                   $CHAR8.                                  
      @993    TOTCHG                   N10PF.                                   
      @1003   TOTCHG_X                 N15P2F.                                  
      @1018   TRAN_IN                  N2PF.                                    
      @1020   TRAN_OUT                 N2PF.                                    
      @1022   YEAR                     N4PF.                                    
      @1026   ZIPINC_QRTL              N3PF.                                    
      @1029   TOWN                     $CHAR2.                                  
      @1031   ZIP                      $CHAR5.                                  
      @1036   AYEAR                    N4PF.                                    
      @1040   DMONTH                   N2PF.                                    
