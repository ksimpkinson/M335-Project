...
*   UT_SID_2015q1q3_DX_PR_GRPS.SAS:                                             
...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SIDC_2015q1q3_DX_PR_GRPS;                                               
INFILE 'UT_SID_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 592;                 
...
INPUT                                                                           
      ...
      @426    INJURY                        N2PF.                               
      @428    INJURY_CUT                    N2PF.                               
      @430    INJURY_DROWN                  N2PF.                               
      @432    INJURY_FALL                   N2PF.                               
      @434    INJURY_FIRE                   N2PF.                               
      @436    INJURY_FIREARM                N2PF.                               
      @438    INJURY_MACHINERY              N2PF.                               
      @440    INJURY_MVT                    N2PF.                               
      @442    INJURY_NATURE                 N2PF.                               
      @444    INJURY_POISON                 N2PF.                               
      @446    INJURY_STRUCK                 N2PF.                               
      @448    INJURY_SUFFOCATION            N2PF.                               
      @450    INTENT_ASSAULT                N2PF.                               
      @452    INTENT_SELF_HARM              N2PF.                               
      @454    INTENT_UNINTENTIONAL          N2PF.                               
      @456    KEY                           15.                                 
      @471    MULTINJURY                    N2PF.                               
      @473    PCLASS1                       N2PF.                               
      @475    PCLASS2                       N2PF.                               
      ...
      @567    U_NEWBN4L                     N2PF.                               
      @569    U_NUCMED                      N2PF.                               
      @571    U_OBSERVATION                 N2PF.                               
      @573    U_OCCTHERAPY                  N2PF.                               
      @575    U_ORGANACQ                    N2PF.                               
      @577    U_OTHIMPLANTS                 N2PF.                               
      @579    U_PACEMAKER                   N2PF.                               
      @581    U_PHYTHERAPY                  N2PF.                               
      @583    U_RADTHERAPY                  N2PF.                               
      @585    U_RESPTHERAPY                 N2PF.                               
      @587    U_SPEECHTHERAPY               N2PF.                               
      @589    U_STRESS                      N2PF.                               
      @591    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
