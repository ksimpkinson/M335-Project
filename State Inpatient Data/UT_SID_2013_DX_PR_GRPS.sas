...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SIDC_2013_DX_PR_GRPS;                                                   
INFILE 'UT_SID_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 401;                     
...
INPUT                                                                           
      ...
      @235    INJURY                        N2PF.                               
      @237    INJURY_CUT                    N2PF.                               
      @239    INJURY_DROWN                  N2PF.                               
      @241    INJURY_FALL                   N2PF.                               
      @243    INJURY_FIRE                   N2PF.                               
      @245    INJURY_FIREARM                N2PF.                               
      @247    INJURY_MACHINERY              N2PF.                               
      @249    INJURY_MVT                    N2PF.                               
      @251    INJURY_NATURE                 N2PF.                               
      @253    INJURY_POISON                 N2PF.                               
      @255    INJURY_STRUCK                 N2PF.                               
      @257    INJURY_SUFFOCATION            N2PF.                               
      @259    INTENT_ASSAULT                N2PF.                               
      @261    INTENT_SELF_HARM              N2PF.                               
      @263    INTENT_UNINTENTIONAL          N2PF.                               
      @265    KEY                           15.                                 
      @280    MULTINJURY                    N2PF.                               
      @282    PCLASS1                       N2PF.                               
      @284    PCLASS2                       N2PF.                               
      ...
      @376    U_NEWBN4L                     N2PF.                               
      @378    U_NUCMED                      N2PF.                               
      @380    U_OBSERVATION                 N2PF.                               
      @382    U_OCCTHERAPY                  N2PF.                               
      @384    U_ORGANACQ                    N2PF.                               
      @386    U_OTHIMPLANTS                 N2PF.                               
      @388    U_PACEMAKER                   N2PF.                               
      @390    U_PHYTHERAPY                  N2PF.                               
      @392    U_RADTHERAPY                  N2PF.                               
      @394    U_RESPTHERAPY                 N2PF.                               
      @396    U_SPEECHTHERAPY               N2PF.                               
      @398    U_STRESS                      N2PF.                               
      @400    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
