...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SIDC_2012_DX_PR_GRPS;                                                   
INFILE 'NV_SID_2012_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 766;                     
...
INPUT                                                                           
      ...
      @540    INJURY                   N2PF.                                    
      @542    INJURY_CUT               N2PF.                                    
      @544    INJURY_DROWN             N2PF.                                    
      @546    INJURY_FALL              N2PF.                                    
      @548    INJURY_FIRE              N2PF.                                    
      @550    INJURY_FIREARM           N2PF.                                    
      @552    INJURY_MACHINERY         N2PF.                                    
      @554    INJURY_MVT               N2PF.                                    
      @556    INJURY_NATURE            N2PF.                                    
      @558    INJURY_POISON            N2PF.                                    
      @560    INJURY_STRUCK            N2PF.                                    
      @562    INJURY_SUFFOCATION       N2PF.                                    
      @564    INTENT_ASSAULT           N2PF.                                    
      @566    INTENT_SELF_HARM         N2PF.                                    
      @568    INTENT_UNINTENTIONAL     N2PF.                                    
      @570    KEY                      15.                                      
      @585    MULTINJURY               N2PF.                                    
      @587    PCLASS1                  N2PF.                                    
      @589    PCLASS2                  N2PF.                                    
      ...
      @741    U_NEWBN4L                N2PF.                                    
      @743    U_NUCMED                 N2PF.                                    
      @745    U_OBSERVATION            N2PF.                                    
      @747    U_OCCTHERAPY             N2PF.                                    
      @749    U_ORGANACQ               N2PF.                                    
      @751    U_OTHIMPLANTS            N2PF.                                    
      @753    U_PACEMAKER              N2PF.                                    
      @755    U_PHYTHERAPY             N2PF.                                    
      @757    U_RADTHERAPY             N2PF.                                    
      @759    U_RESPTHERAPY            N2PF.                                    
      @761    U_SPEECHTHERAPY          N2PF.                                    
      @763    U_STRESS                 N2PF.                                    
      @765    U_ULTRASOUND             N2PF.                                    
      ;                                                                         
