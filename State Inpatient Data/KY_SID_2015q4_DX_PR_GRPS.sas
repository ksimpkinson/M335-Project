...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'KY_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 803;                   
...
INPUT                                                                           
      ...
      @475    I10_INJURY                    N2PF.                               
      @477    I10_MULTINJURY                N2PF.                               
      @479    I10_PCLASS1                   N2PF.                               
      @481    I10_PCLASS2                   N2PF.                               
      @483    I10_PCLASS3                   N2PF.                               
      @485    I10_PCLASS4                   N2PF.                               
      @487    I10_PCLASS5                   N2PF.                               
      @489    I10_PCLASS6                   N2PF.                               
      @491    I10_PCLASS7                   N2PF.                               
      @493    I10_PCLASS8                   N2PF.                               
      @495    I10_PCLASS9                   N2PF.                               
      @497    I10_PCLASS10                  N2PF.                               
      @499    I10_PCLASS11                  N2PF.                               
      @501    I10_PCLASS12                  N2PF.                               
      @503    I10_PCLASS13                  N2PF.                               
      @505    I10_PCLASS14                  N2PF.                               
      @507    I10_PCLASS15                  N2PF.                               
      @509    I10_PCLASS16                  N2PF.                               
      @511    I10_PCLASS17                  N2PF.                               
      @513    I10_PCLASS18                  N2PF.                               
      @515    I10_PCLASS19                  N2PF.                               
      @517    I10_PCLASS20                  N2PF.                               
      @519    I10_PCLASS21                  N2PF.                               
      @521    I10_PCLASS22                  N2PF.                               
      @523    I10_PCLASS23                  N2PF.                               
      @525    I10_PCLASS24                  N2PF.                               
      @527    I10_PCLASS25                  N2PF.                               
      @529    I10_PRMCCS1                   $CHAR8.                             
      @537    I10_PRMCCS2                   $CHAR8.                             
      @545    I10_PRMCCS3                   $CHAR8.                             
      @553    I10_PRMCCS4                   $CHAR8.                             
      @561    I10_PRMCCS5                   $CHAR8.                             
      @569    I10_PRMCCS6                   $CHAR8.                             
      @577    I10_PRMCCS7                   $CHAR8.                             
      @585    I10_PRMCCS8                   $CHAR8.                             
      @593    I10_PRMCCS9                   $CHAR8.                             
      @601    I10_PRMCCS10                  $CHAR8.                             
      @609    I10_PRMCCS11                  $CHAR8.                             
      @617    I10_PRMCCS12                  $CHAR8.                             
      @625    I10_PRMCCS13                  $CHAR8.                             
      @633    I10_PRMCCS14                  $CHAR8.                             
      @641    I10_PRMCCS15                  $CHAR8.                             
      @649    I10_PRMCCS16                  $CHAR8.                             
      @657    I10_PRMCCS17                  $CHAR8.                             
      @665    I10_PRMCCS18                  $CHAR8.                             
      @673    I10_PRMCCS19                  $CHAR8.                             
      @681    I10_PRMCCS20                  $CHAR8.                             
      @689    I10_PRMCCS21                  $CHAR8.                             
      @697    I10_PRMCCS22                  $CHAR8.                             
      @705    I10_PRMCCS23                  $CHAR8.                             
      @713    I10_PRMCCS24                  $CHAR8.                             
      @721    I10_PRMCCS25                  $CHAR8.                             
      @729    I10_U_BLOOD                   N2PF.                               
      @731    I10_U_CATH                    N2PF.                               
      @733    I10_U_CTSCAN                  N2PF.                               
      @735    I10_U_EKG                     N2PF.                               
      @737    I10_U_MHSA                    N2PF.                               
      @739    I10_U_MRT                     N2PF.                               
      @741    I10_U_PACEMAKER               N2PF.                               
      @743    I10_U_PHYTHERAPY              N2PF.                               
      @745    I10_U_RADTHERAPY              N2PF.                               
      @747    I10_U_STRESS                  N2PF.                               
      @749    KEY                           15.                                 
      @764    U_CCU                         N2PF.                               
      @766    U_CHESTXRAY                   N2PF.                               
      @768    U_DIALYSIS                    N2PF.                               
      @770    U_ECHO                        N2PF.                               
      @772    U_ED                          N2PF.                               
      @774    U_EEG                         N2PF.                               
      @776    U_EPO                         N2PF.                               
      @778    U_ICU                         N2PF.                               
      @780    U_LITHOTRIPSY                 N2PF.                               
      @782    U_NEWBN2L                     N2PF.                               
      @784    U_NEWBN3L                     N2PF.                               
      @786    U_NEWBN4L                     N2PF.                               
      @788    U_NUCMED                      N2PF.                               
      @790    U_OBSERVATION                 N2PF.                               
      @792    U_OCCTHERAPY                  N2PF.                               
      @794    U_ORGANACQ                    N2PF.                               
      @796    U_OTHIMPLANTS                 N2PF.                               
      @798    U_RESPTHERAPY                 N2PF.                               
      @800    U_SPEECHTHERAPY               N2PF.                               
      @802    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
