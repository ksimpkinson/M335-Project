...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SIDC_2009_CORE;                                                         
INFILE 'RI_SID_2009_CORE.ASC' LRECL = 1138;                                     
...
INPUT                                                                           
      ...
      @572    NEOMAT                   N2PF.                                    
      @574    NPR                      N2PF.                                    
      @576    OBSERVATION              N4PF.                                    
      @580    ORPROC                   N2PF.                                    
      @582    PAY1                     N2PF.                                    
      @584    PAY1_X                   $CHAR7.                                  
      @591    PL_CBSA                  N3PF.                                    
      @594    PL_MSA1993               N3PF.                                    
      @597    PL_NCHS2006              N2PF.                                    
      @599    PL_RUCA10_2005           N2PF.                                    
      @601    PL_RUCA2005              N4P1F.                                   
      @605    PL_RUCA4_2005            N2PF.                                    
      @607    PL_RUCC2003              N2PF.                                    
      @609    PL_UIC2003               N2PF.                                    
      @611    PL_UR_CAT4               N2PF.                                    
      @613    PR1                      $CHAR4.                                  
      @617    PR2                      $CHAR4.                                  
      ...
      @918    PSTCO                    N5PF.                                    
      @923    PSTCO2                   N5PF.                                    
      @928    PointOfOriginUB04        $CHAR1.                                  
      @929    PointOfOrigin_X          $CHAR1.                                  
      @930    RACE                     N2PF.                                    
      @932    RACE_X                   $CHAR8.                                  
      @940    TOTCHG                   N10PF.                                   
      @950    TOTCHG_X                 N15P2F.                                  
