...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'RI_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 776;                   
...
INPUT                                                                           
      ...
      @486    I10_ECauseMCCS11              $CHAR11.                            
      @497    I10_ECauseMCCS12              $CHAR11.                            
      @508    I10_INJURY                    N2PF.                               
      @510    I10_MULTINJURY                N2PF.                               
      @512    I10_PCLASS1                   N2PF.                               
      @514    I10_PCLASS2                   N2PF.                               
      @516    I10_PCLASS3                   N2PF.                               
      @518    I10_PCLASS4                   N2PF.                               
      @520    I10_PCLASS5                   N2PF.                               
      @522    I10_PCLASS6                   N2PF.                               
      @524    I10_PCLASS7                   N2PF.                               
      @526    I10_PCLASS8                   N2PF.                               
      @528    I10_PCLASS9                   N2PF.                               
      @530    I10_PCLASS10                  N2PF.                               
      @532    I10_PCLASS11                  N2PF.                               
      @534    I10_PCLASS12                  N2PF.                               
      @536    I10_PCLASS13                  N2PF.                               
      @538    I10_PCLASS14                  N2PF.                               
      @540    I10_PCLASS15                  N2PF.                               
      @542    I10_PCLASS16                  N2PF.                               
      @544    I10_PCLASS17                  N2PF.                               
      @546    I10_PCLASS18                  N2PF.                               
      @548    I10_PCLASS19                  N2PF.                               
      @550    I10_PCLASS20                  N2PF.                               
      @552    I10_PCLASS21                  N2PF.                               
      @554    I10_PCLASS22                  N2PF.                               
      @556    I10_PCLASS23                  N2PF.                               
      @558    I10_PCLASS24                  N2PF.                               
      @560    I10_PCLASS25                  N2PF.                               
      @562    I10_PRMCCS1                   $CHAR8.                             
      @570    I10_PRMCCS2                   $CHAR8.                             
      @578    I10_PRMCCS3                   $CHAR8.                             
      @586    I10_PRMCCS4                   $CHAR8.                             
      @594    I10_PRMCCS5                   $CHAR8.                             
      @602    I10_PRMCCS6                   $CHAR8.                             
      @610    I10_PRMCCS7                   $CHAR8.                             
      @618    I10_PRMCCS8                   $CHAR8.                             
      @626    I10_PRMCCS9                   $CHAR8.                             
      @634    I10_PRMCCS10                  $CHAR8.                             
      @642    I10_PRMCCS11                  $CHAR8.                             
      @650    I10_PRMCCS12                  $CHAR8.                             
      @658    I10_PRMCCS13                  $CHAR8.                             
      @666    I10_PRMCCS14                  $CHAR8.                             
      @674    I10_PRMCCS15                  $CHAR8.                             
      @682    I10_PRMCCS16                  $CHAR8.                             
      @690    I10_PRMCCS17                  $CHAR8.                             
      @698    I10_PRMCCS18                  $CHAR8.                             
      @706    I10_PRMCCS19                  $CHAR8.                             
      @714    I10_PRMCCS20                  $CHAR8.                             
      @722    I10_PRMCCS21                  $CHAR8.                             
      @730    I10_PRMCCS22                  $CHAR8.                             
      @738    I10_PRMCCS23                  $CHAR8.                             
      @746    I10_PRMCCS24                  $CHAR8.                             
      @754    I10_PRMCCS25                  $CHAR8.                             
      @762    KEY                           15.                                 
      ;                                                                         
