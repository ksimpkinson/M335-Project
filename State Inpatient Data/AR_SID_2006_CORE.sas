...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SIDC_2006_CORE;                                                         
INFILE 'AR_SID_2006_CORE.ASC' LRECL = 495;                                      
...
INPUT                                                                           
      ...
      @231    LOS                      N5PF.                                    
      @236    LOS_X                    N6PF.                                    
      @242    MARITALSTATUS            $CHAR1.                                  
      @243    MDC                      N2PF.                                    
      @245    MDC18                    N2PF.                                    
      @247    MDC24                    N2PF.                                    
      @249    MDNUM1_R                 N9PF.                                    
      @258    MDNUMTYPE1               $CHAR1.                                  
      @259    MDNUM2_R                 N9PF.                                    
      @268    MDNUM3_R                 N9PF.                                    
      @277    MDNUM4_R                 N9PF.                                    
      @286    MEDINCSTQ                N2PF.                                    
      ...
      @315    PL_CBSA                  N3PF.                                    
      @318    PL_MSA1993               N3PF.                                    
      @321    PL_NHCS2006              N2PF.                                    
      @323    PL_RUCA10_2005           N2PF.                                    
      @325    PL_RUCA2005              N4P1F.                                   
      @329    PL_RUCA4_2005            N2PF.                                    
      @331    PL_RUCC2003              N2PF.                                    
      @333    PL_UIC2003               N2PF.                                    
      @335    PL_UR_CAT4               N2PF.                                    
      @337    PL_UR_CAT5               N2PF.                                    
      @339    PNUM_R                   N9PF.                                    
