...
*  Data Step                  *;                                                
*******************************;                                                
DATA WA_SIDC_2011_CORE;                                                         
INFILE 'WA_SID_2011_CORE.ASC' LRECL = 945;                                      
...
INPUT                                                                           
      ...
      @420    HCUP_ED                  N2PF.                                    
      @422    HCUP_OS                  N2PF.                                    
      @424    HCUP_SURGERY_BROAD       N2PF.                                    
      @426    HCUP_SURGERY_NARROW      N2PF.                                    
      @428    HISPANIC_X               $CHAR1.                                  
      @429    HOSPBRTH                 N3PF.                                    
      @432    HOSPST                   $CHAR2.                                  
      @434    Homeless                 N2PF.                                    
      @436    HospitalUnit             N2PF.                                    
      @438    KEY                      18.                                      
      @456    LOS                      N5PF.                                    
      @461    LOS_X                    N6PF.                                    
      @467    MDC                      N2PF.                                    
      ...
      @547    PL_CBSA                  N3PF.                                    
      @550    PL_MSA1993               N3PF.                                    
      @553    PL_NCHS2006              N2PF.                                    
      @555    PL_RUCA10_2005           N2PF.                                    
      @557    PL_RUCA2005              N4P1F.                                   
      @561    PL_RUCA4_2005            N2PF.                                    
      @563    PL_RUCC2003              N2PF.                                    
      @565    PL_UIC2003               N2PF.                                    
      @567    PL_UR_CAT4               N2PF.                                    
      @569    PR1                      $CHAR4.                                  
      @573    PR2                      $CHAR4.                                  
      ...
      @872    PSTATE                   $CHAR2.                                  
      @874    PSTCO2                   N5PF.                                    
      @879    PointOfOriginUB04        $CHAR1.                                  
      @880    PointOfOrigin_X          $CHAR1.                                  
      @881    RACE                     N2PF.                                    
      @883    RACE_X                   $CHAR6.                                  
      @889    TOTCHG                   N10PF.                                   
      @899    TOTCHG_X                 N15P2F.                                  
