...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SIDC_2013_DX_PR_GRPS;                                                   
INFILE 'OR_SID_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 765;                     
...
INPUT                                                                           
      ...
      @409    INJURY                   N2PF.                                    
      @411    INJURY_CUT               N2PF.                                    
      @413    INJURY_DROWN             N2PF.                                    
      @415    INJURY_FALL              N2PF.                                    
      @417    INJURY_FIRE              N2PF.                                    
      @419    INJURY_FIREARM           N2PF.                                    
      @421    INJURY_MACHINERY         N2PF.                                    
      @423    INJURY_MVT               N2PF.                                    
      @425    INJURY_NATURE            N2PF.                                    
      @427    INJURY_POISON            N2PF.                                    
      @429    INJURY_STRUCK            N2PF.                                    
      @431    INJURY_SUFFOCATION       N2PF.                                    
      @433    INTENT_ASSAULT           N2PF.                                    
      @435    INTENT_SELF_HARM         N2PF.                                    
      @437    INTENT_UNINTENTIONAL     N2PF.                                    
      @439    KEY                      15.                                      
      @454    MULTINJURY               N2PF.                                    
      @456    PCLASS1                  N2PF.                                    
      @458    PCLASS2                  N2PF.                                    
      ...
      @740    U_NEWBN4L                N2PF.                                    
      @742    U_NUCMED                 N2PF.                                    
      @744    U_OBSERVATION            N2PF.                                    
      @746    U_OCCTHERAPY             N2PF.                                    
      @748    U_ORGANACQ               N2PF.                                    
      @750    U_OTHIMPLANTS            N2PF.                                    
      @752    U_PACEMAKER              N2PF.                                    
      @754    U_PHYTHERAPY             N2PF.                                    
      @756    U_RADTHERAPY             N2PF.                                    
      @758    U_RESPTHERAPY            N2PF.                                    
      @760    U_SPEECHTHERAPY          N2PF.                                    
      @762    U_STRESS                 N2PF.                                    
      @764    U_ULTRASOUND             N2PF.                                    
      ;                                                                         
