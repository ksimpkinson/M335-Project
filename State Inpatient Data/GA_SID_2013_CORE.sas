...
*  Data Step                  *;                                                
*******************************;                                                
DATA GA_SIDC_2013_CORE;                                                         
INFILE 'GA_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 2592;                          
...
INPUT                                                                           
      ...
      @1328   LOS                           N5PF.                               
      @1333   LOS_X                         N6PF.                               
      @1339   MARITALSTATUSUB04             $CHAR1.                             
      @1340   MARITALSTATUS_X               $CHAR1.                             
      @1341   MDC                           N2PF.                               
      @1343   MDC24                         N2PF.                               
      @1345   MDC_NoPOA                     N2PF.                               
      @1347   MDNUM1_R                      N9PF.                               
      ...
      @1433   PL_CBSA                       N3PF.                               
      @1436   PL_NCHS                       N2PF.                               
      @1438   PL_RUCA10_2005                N2PF.                               
      @1440   PL_RUCA2005                   N4P1F.                              
      @1444   PL_RUCA4_2005                 N2PF.                               
      @1446   PL_RUCC                       N2PF.                               
      @1448   PL_UIC                        N2PF.                               
      @1450   PL_UR_CAT4                    N2PF.                               
      @1452   PR1                           $CHAR7.                             
      @1459   PR2                           $CHAR7.                             
      @1466   PR3                           $CHAR7.                             
      @1473   PR4                           $CHAR7.                             
      ...
      @2218   PointOfOrigin_X               $CHAR1.                             
      @2219   PrimLang                      $CHAR3.                             
      @2222   RACE                          N2PF.                               
      @2224   RACE_X                        $CHAR1.                             
      @2225   TOTCHG                        N10PF.                              
      @2235   TOTCHG_X                      N15P2F.                             
      @2250   TRAN_IN                       N2PF.                               
      @2252   TRAN_OUT                      N2PF.                               
      @2254   VisitLink                     N9PF.                               
      @2263   YEAR                          N4PF.                               
      @2267   ZIP3                          $CHAR3.                             
      @2270   ZIPINC_QRTL                   N3PF.                               
      @2273   HOSPID                        N5PF.                               
      @2278   ZIP                           $CHAR5.                             
      @2283   AYEAR                         N4PF.                               
      @2287   BMONTH                        N2PF.                               
