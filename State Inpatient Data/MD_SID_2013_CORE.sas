...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SIDC_2013_CORE;                                                         
INFILE 'MD_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1222;                          
...
INPUT                                                                           
      ...
      @564    HCUP_ED                       N2PF.                               
      @566    HCUP_OS                       N2PF.                               
      @568    HISPANIC_X                    $CHAR1.                             
      @569    HOSPBRTH                      N3PF.                               
      @572    HOSPST                        $CHAR2.                             
      @574    HospitalUnit                  N2PF.                               
      @576    KEY                           15.                                 
      @591    LOS                           N5PF.                               
      @596    LOS_X                         N6PF.                               
      @602    MARITALSTATUSUB04             $CHAR1.                             
      @603    MARITALSTATUS_X               $CHAR1.                             
      @604    MDC                           N2PF.                               
      @606    MDC24                         N2PF.                               
      @608    MDC_NoPOA                     N2PF.                               
      @610    MDNUM1_R                      N9PF.                               
      ...
      @679    PL_CBSA                       N3PF.                               
      @682    PL_NCHS                       N2PF.                               
      @684    PL_RUCA10_2005                N2PF.                               
      @686    PL_RUCA2005                   N4P1F.                              
      @690    PL_RUCA4_2005                 N2PF.                               
      @692    PL_RUCC                       N2PF.                               
      @694    PL_UIC                        N2PF.                               
      @696    PL_UR_CAT4                    N2PF.                               
      @698    PR1                           $CHAR7.                             
      ...
      @1169   READMIT                       N2PF.                               
      @1171   TOTCHG                        N10PF.                              
      @1181   TOTCHG_X                      N15P2F.                             
      @1196   TRAN_IN                       N2PF.                               
      @1198   TRAN_OUT                      N2PF.                               
      @1200   VisitLink                     N9PF.                               
      @1209   YEAR                          N4PF.                               
      @1213   ZIP3                          $CHAR3.                             
      @1216   ZIPINC_QRTL                   N3PF.                               
      @1219   AYEAR                         N4PF.                               
      ;                                                                         
