...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SIDC_2016_CORE;                                                         
INFILE 'WI_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 2027;                          
...
INPUT                                                                           
      ...
      @942    HCUP_OS                       N2PF.                               
      @944    HISPANIC                      N2PF.                               
      @946    HISPANIC_X                    $CHAR1.                             
      @947    Homeless                      N2PF.                               
      @949    HOSP_NPI                      $CHAR10.                            
      @959    HOSPST                        $CHAR2.                             
      @961    I10_DX_Admitting              $CHAR7.                             
      @968    I10_DX1                       $CHAR7.                             
      @975    I10_DX2                       $CHAR7.                             
      @982    I10_DX3                       $CHAR7.                             
      @989    I10_DX4                       $CHAR7.                             
      ...
      @1409   I10_DX64                      $CHAR7.                             
      @1416   I10_DX65                      $CHAR7.                             
      @1423   I10_ECAUSE1                   $CHAR7.                             
      @1430   I10_ECAUSE2                   $CHAR7.                             
      @1437   I10_ECAUSE3                   $CHAR7.                             
      @1444   I10_ECAUSE4                   $CHAR7.                             
      @1451   I10_ECAUSE5                   $CHAR7.                             
      @1458   I10_ECAUSE6                   $CHAR7.                             
      @1465   I10_ECAUSE7                   $CHAR7.                             
      @1472   I10_NDX                       N3PF.                               
      @1475   I10_NECAUSE                   N2PF.                               
      @1477   I10_NPR                       N3PF.                               
      @1480   I10_PR1                       $CHAR7.                             
      @1487   I10_PR2                       $CHAR7.                             
      @1494   I10_PR3                       $CHAR7.                             
      ...
      @1914   PL_RUCC                       N2PF.                               
      @1916   PL_UIC                        N2PF.                               
      @1918   PL_UR_CAT4                    N2PF.                               
      @1920   POA_Disch_Edit1               N2PF.                               
      @1922   POA_Disch_Edit2               N2PF.                               
      @1924   POA_Hosp_Edit1                N2PF.                               
      @1926   POA_Hosp_Edit2                N2PF.                               
      @1928   POA_Hosp_Edit3                N2PF.                               
      @1930   POA_Hosp_Edit3_Value          N8P2F.                              
      @1938   PointOfOrigin_X               $CHAR1.                             
      @1939   PointOfOriginUB04             $CHAR1.                             
      @1940   PRDAY1                        N5PF.                               
      @1945   PRVER                         N3PF.                               
      @1948   PSTATE                        $CHAR2.                             
      @1950   PSTCO2                        N5PF.                               
