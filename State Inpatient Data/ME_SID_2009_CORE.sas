...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SIDC_2009_CORE;                                                         
INFILE 'ME_SID_2009_CORE.ASC' LRECL = 431;                                      
...
INPUT                                                                           
      ...
      @258    PL_CBSA                  N3PF.                                    
      @261    PL_MSA1993               N3PF.                                    
      @264    PL_NCHS2006              N2PF.                                    
      @266    PL_RUCA4_2005            N2PF.                                    
      @268    PL_UIC2003               N2PF.                                    
      @270    PL_UR_CAT4               N2PF.                                    
      @272    PR1                      $CHAR4.                                  
      @276    PR2                      $CHAR4.                                  
